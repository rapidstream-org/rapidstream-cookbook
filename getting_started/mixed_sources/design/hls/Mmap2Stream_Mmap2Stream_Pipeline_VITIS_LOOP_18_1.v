...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if ((ap_loop_init == 1'b1)) begin
            i_fu_48 <= 64'd0;
        end else if (((ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln18_fu_88_p2 == 1'd0))) begin
            i_fu_48 <= i_2_fu_93_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        mmap_addr_read_reg_135 <= m_axi_mmap_RDATA;
    end
end

always @ (*) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln18_fu_88_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = (m_axi_mmap_RVALID == 1'b0);
end
...
assign i_2_fu_93_p2 = (i_fu_48 + 64'd1);

assign icmp_ln18_fu_88_p2 = ((i_fu_48 == n) ? 1'b1 : 1'b0);
...
assign stream_din = mmap_addr_read_reg_135;
