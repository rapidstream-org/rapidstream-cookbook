...
module Stream2Mmap_Stream2Mmap_Pipeline_VITIS_LOOP_22_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [31:0] trunc_ln85_fu_108_p1;
reg   [31:0] trunc_ln85_reg_139;
reg    ap_block_pp0_stage0_01001;
reg   [63:0] i_fu_50;
wire   [63:0] i_2_fu_97_p2;
wire    ap_loop_init;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if ((ap_loop_init == 1'b1)) begin
            i_fu_50 <= 64'd0;
        end else if (((ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln22_fu_92_p2 == 1'd0))) begin
            i_fu_50 <= i_2_fu_97_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        trunc_ln85_reg_139 <= trunc_ln85_fu_108_p1;
    end
end

always @ (*) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln22_fu_92_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = (((m_axi_mmap_WREADY == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state3_pp0_stage0_iter2)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((m_axi_mmap_WREADY == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state3_pp0_stage0_iter2)));
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = (stream_s_empty_n == 1'b0);
end
...
assign i_2_fu_97_p2 = (i_fu_50 + 64'd1);

assign icmp_ln22_fu_92_p2 = ((i_fu_50 == n) ? 1'b1 : 1'b0);
...
assign m_axi_mmap_WDATA = trunc_ln85_reg_139;
...
assign trunc_ln85_fu_108_p1 = stream_s_dout[31:0];

endmodule //Stream2Mmap_Stream2Mmap_Pipeline_VITIS_LOOP_22_1
