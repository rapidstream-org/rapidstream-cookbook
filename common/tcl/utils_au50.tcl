...
proc create_shell_design_1 {} {
  ...
  proc create_root_design { parentCell } {
    ...
    connect_bd_net -net kernel_sys_reset_peripheral_aresetn [get_bd_pins cl_0/ARESETN_KL] [get_bd_pins kernel_sys_reset/peripheral_aresetn]
    ...
    connect_bd_net -net xdma_0_axi_aclk [get_bd_pins cl_0/CLK_XDMA] [get_bd_pins hbm_axi_clk/clk_in1] [get_bd_pins kernel_clk/clk_in1] [get_bd_pins xdma_0/axi_aclk]
    connect_bd_net -net xdma_0_axi_aresetn [get_bd_pins cl_0/ARESETN_XDMA] [get_bd_pins hbm_axi_clk/resetn] [get_bd_pins hbm_sys_reset/ext_reset_in] [get_bd_pins kernel_clk/resetn] [get_bd_pins kernel_sys_reset/ext_reset_in] [get_bd_pins proc_sys_reset_2/ext_reset_in] [get_bd_pins xdma_0/axi_aresetn]
