...
The module types for your design can be found in `build/module_types.csv`. Below, we list the four Group modules. In this design, `bert_all` serves as a Group module, while the other modules are inferred by RapidStream automatically.
...
| bert_all_Bert_layer_dataflow_region_1	      | grouped_module |
| bert_all_Bert_layer_dataflow_region_2	      | grouped_module |
| bert_all_Bert_layer_dataflow_region_3	      | grouped_module |
| bert_all_Gelu_layer	                        | grouped_module |
| bert_all_Linear_layer_ds1	                  | grouped_module |
| bert_all_Linear_layer_ds2	                  | grouped_module |
| bert_all_block_gemm_proc101	                | grouped_module |
| bert_all_block_gemm_proc101_wrapper	        | grouped_module |
| bert_all_block_gemm_proc98	                | grouped_module |
| bert_all_block_gemm_proc98_wrapper	        | grouped_module |
| bert_all_dataflow_in_loop_block_gemm_92899	| grouped_module |
| bert_all_dataflow_in_loop_block_gemm_93196	| grouped_module |
| bert_all_dataflow_in_loop_l_pack_seq_929	  | grouped_module |
| bert_all_dataflow_in_loop_l_pack_seq_930	  | grouped_module |
| bert_all_dataflow_in_loop_l_pack_seq_932	  | grouped_module |
| bert_all_systolic_array_ds1132	            | grouped_module |
| bert_all_systolic_array_ds2137	            | grouped_module |


### Step 4: Call `vivado` to Generate Bitstream
