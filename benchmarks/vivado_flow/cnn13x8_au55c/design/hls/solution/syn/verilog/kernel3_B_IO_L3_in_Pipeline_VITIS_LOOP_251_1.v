...
module kernel3_B_IO_L3_in_Pipeline_VITIS_LOOP_251_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [13:0] i_V_fu_58;
wire   [13:0] add_ln840_fu_98_p2;
wire    ap_loop_init;
reg   [13:0] ap_sig_allocacmp_i_V_2;
...
assign add_ln840_fu_98_p2 = (ap_sig_allocacmp_i_V_2 + 14'd1);
...
assign icmp_ln1027_fu_92_p2 = ((ap_sig_allocacmp_i_V_2 == 14'd8192) ? 1'b1 : 1'b0);
...
endmodule //kernel3_B_IO_L3_in_Pipeline_VITIS_LOOP_251_1
