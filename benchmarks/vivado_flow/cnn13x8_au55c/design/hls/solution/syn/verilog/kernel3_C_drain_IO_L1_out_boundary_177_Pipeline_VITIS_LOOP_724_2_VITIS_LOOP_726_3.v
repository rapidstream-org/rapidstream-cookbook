...
module kernel3_C_drain_IO_L1_out_boundary_177_Pipeline_VITIS_LOOP_724_2_VITIS_LOOP_726_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln729_6_fu_197_p1;
reg   [5:0] c6_V_fu_58;
wire   [5:0] add_ln840_12_fu_176_p2;
wire    ap_loop_init;
reg   [5:0] ap_sig_allocacmp_c6_V_load;
reg   [4:0] c5_V_fu_62;
wire   [4:0] select_ln1039_20_fu_146_p3;
...
wire   [0:0] icmp_ln1039_14_fu_132_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln1039_fu_108_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            c5_V_fu_62 <= select_ln1039_20_fu_146_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln1039_fu_108_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            c6_V_fu_58 <= add_ln840_12_fu_176_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            c6_V_fu_58 <= 6'd0;
        end
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter3 == 1'b1))) begin
        fifo_C_drain_C_drain_IO_L1_out_3_12408_blk_n = fifo_C_drain_C_drain_IO_L1_out_3_12408_full_n;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter3 == 1'b1))) begin
        fifo_C_drain_C_drain_IO_L1_out_3_12408_write = 1'b1;
    end else begin
...
assign add_ln840_12_fu_176_p2 = (select_ln1039_fu_138_p3 + 6'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((fifo_C_drain_C_drain_IO_L1_out_3_12408_full_n == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((fifo_C_drain_C_drain_IO_L1_out_3_12408_full_n == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((fifo_C_drain_C_drain_IO_L1_out_3_12408_full_n == 1'b0) & (ap_enable_reg_pp0_iter3 == 1'b1));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter3 = (fifo_C_drain_C_drain_IO_L1_out_3_12408_full_n == 1'b0);
end
...
assign fifo_C_drain_C_drain_IO_L1_out_3_12408_din = local_C_V_load_reg_236;

assign icmp_ln1039_14_fu_132_p2 = ((ap_sig_allocacmp_c6_V_load == 6'd32) ? 1'b1 : 1'b0);

assign icmp_ln1039_fu_108_p2 = ((ap_sig_allocacmp_indvar_flatten6_load == 10'd512) ? 1'b1 : 1'b0);

assign local_C_V_address0 = zext_ln729_6_fu_197_p1;

assign select_ln1039_20_fu_146_p3 = ((icmp_ln1039_14_fu_132_p2[0:0] == 1'b1) ? add_ln840_fu_126_p2 : ap_sig_allocacmp_c5_V_load);

assign select_ln1039_fu_138_p3 = ((icmp_ln1039_14_fu_132_p2[0:0] == 1'b1) ? 6'd0 : ap_sig_allocacmp_c6_V_load);

assign tmp_s_fu_158_p3 = {{trunc_ln729_fu_154_p1}, {5'd0}};

assign trunc_ln729_fu_154_p1 = select_ln1039_20_fu_146_p3[3:0];

assign zext_ln729_6_fu_197_p1 = add_ln729_reg_226;

assign zext_ln729_fu_166_p1 = select_ln1039_fu_138_p3;

endmodule //kernel3_C_drain_IO_L1_out_boundary_177_Pipeline_VITIS_LOOP_724_2_VITIS_LOOP_726_3
