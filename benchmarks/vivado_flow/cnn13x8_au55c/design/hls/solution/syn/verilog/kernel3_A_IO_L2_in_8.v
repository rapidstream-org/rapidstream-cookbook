...
module kernel3_A_IO_L2_in_8 (
        ...
        ap_idle,
        ap_ready,
        fifo_A_A_IO_L2_in_811_dout,
        fifo_A_A_IO_L2_in_811_num_data_valid,
        fifo_A_A_IO_L2_in_811_fifo_cap,
        fifo_A_A_IO_L2_in_811_empty_n,
        fifo_A_A_IO_L2_in_811_read,
        fifo_A_A_IO_L2_in_912_din,
        fifo_A_A_IO_L2_in_912_num_data_valid,
        fifo_A_A_IO_L2_in_912_fifo_cap,
        fifo_A_A_IO_L2_in_912_full_n,
        fifo_A_A_IO_L2_in_912_write,
        fifo_A_PE_8_096_din,
        fifo_A_PE_8_096_num_data_valid,
        fifo_A_PE_8_096_fifo_cap,
        fifo_A_PE_8_096_full_n,
        fifo_A_PE_8_096_write
);
...
output   ap_idle;
output   ap_ready;
input  [255:0] fifo_A_A_IO_L2_in_811_dout;
input  [1:0] fifo_A_A_IO_L2_in_811_num_data_valid;
input  [1:0] fifo_A_A_IO_L2_in_811_fifo_cap;
input   fifo_A_A_IO_L2_in_811_empty_n;
output   fifo_A_A_IO_L2_in_811_read;
output  [255:0] fifo_A_A_IO_L2_in_912_din;
input  [1:0] fifo_A_A_IO_L2_in_912_num_data_valid;
input  [1:0] fifo_A_A_IO_L2_in_912_fifo_cap;
input   fifo_A_A_IO_L2_in_912_full_n;
output   fifo_A_A_IO_L2_in_912_write;
output  [255:0] fifo_A_PE_8_096_din;
input  [1:0] fifo_A_PE_8_096_num_data_valid;
input  [1:0] fifo_A_PE_8_096_fifo_cap;
input   fifo_A_PE_8_096_full_n;
output   fifo_A_PE_8_096_write;

reg ap_done;
reg ap_idle;
reg ap_ready;
reg fifo_A_A_IO_L2_in_811_read;
reg fifo_A_A_IO_L2_in_912_write;
reg fifo_A_PE_8_096_write;
...
wire   [255:0] grp_A_IO_L2_in_intra_trans_fu_56_fifo_A_PE_12_0132_din;
wire    grp_A_IO_L2_in_intra_trans_fu_56_fifo_A_PE_12_0132_write;
...
kernel3_A_IO_L2_in_inter_trans grp_A_IO_L2_in_inter_trans_fu_44(
    ...
    .fifo_A_A_IO_L2_in_111411_dout(fifo_A_A_IO_L2_in_811_dout),
    .fifo_A_A_IO_L2_in_111411_num_data_valid(2'd0),
    .fifo_A_A_IO_L2_in_111411_fifo_cap(2'd0),
    .fifo_A_A_IO_L2_in_111411_empty_n(fifo_A_A_IO_L2_in_811_empty_n),
    ...
    .fifo_A_A_IO_L2_in_1215_full_n(fifo_A_A_IO_L2_in_912_full_n),
...
kernel3_A_IO_L2_in_intra_trans grp_A_IO_L2_in_intra_trans_fu_56(
    ...
    .fifo_A_PE_12_0132_din(grp_A_IO_L2_in_intra_trans_fu_56_fifo_A_PE_12_0132_din),
    .fifo_A_PE_12_0132_num_data_valid(2'd0),
    .fifo_A_PE_12_0132_fifo_cap(2'd0),
    .fifo_A_PE_12_0132_full_n(fifo_A_PE_8_096_full_n),
    .fifo_A_PE_12_0132_write(grp_A_IO_L2_in_intra_trans_fu_56_fifo_A_PE_12_0132_write),
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        fifo_A_A_IO_L2_in_811_read = grp_A_IO_L2_in_inter_trans_fu_44_fifo_A_A_IO_L2_in_111411_read;
    end else begin
        fifo_A_A_IO_L2_in_811_read = 1'b0;
    end
end

always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        fifo_A_A_IO_L2_in_912_write = grp_A_IO_L2_in_inter_trans_fu_44_fifo_A_A_IO_L2_in_1215_write;
    end else begin
        fifo_A_A_IO_L2_in_912_write = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) | (1'b1 == ap_CS_fsm_state2))) begin
        fifo_A_PE_8_096_write = grp_A_IO_L2_in_intra_trans_fu_56_fifo_A_PE_12_0132_write;
    end else begin
        fifo_A_PE_8_096_write = 1'b0;
    end
end
...
assign fifo_A_A_IO_L2_in_912_din = grp_A_IO_L2_in_inter_trans_fu_44_fifo_A_A_IO_L2_in_1215_din;

assign fifo_A_PE_8_096_din = grp_A_IO_L2_in_intra_trans_fu_56_fifo_A_PE_12_0132_din;
...
endmodule //kernel3_A_IO_L2_in_8
