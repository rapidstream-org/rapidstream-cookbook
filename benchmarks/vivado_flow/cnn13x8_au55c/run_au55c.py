...
from rapidstream import get_u55c_default_device, RapidStreamHLS
import os
...
rs.set_virtual_device(get_u55c_default_device())
...
rs.assign_port_to_region("slr0_freerun_clk_clk_.*", "SLOT_X1Y0:SLOT_X1Y0")
rs.assign_port_to_region("pci_express_x4_.*", "SLOT_X1Y0:SLOT_X1Y0")
rs.assign_port_to_region("pcie_perstn", "SLOT_X1Y0:SLOT_X1Y0")
rs.assign_port_to_region("pcie_refclk_clk_.*", "SLOT_X1Y0:SLOT_X1Y0")
