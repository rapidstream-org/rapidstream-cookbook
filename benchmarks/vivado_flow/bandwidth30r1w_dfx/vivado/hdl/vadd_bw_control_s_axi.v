...
#(parameter
    ...
    output wire [63:0]                   rmem28,
    output wire [63:0]                   rmem29,
...
// 0x15c : reserved
// 0x160 : Data signal of rmem28
//         bit 31~0 - rmem28[31:0] (Read/Write)
// 0x164 : Data signal of rmem28
//         bit 31~0 - rmem28[63:32] (Read/Write)
// 0x168 : reserved
// 0x16c : Data signal of rmem29
//         bit 31~0 - rmem29[31:0] (Read/Write)
// 0x170 : Data signal of rmem29
//         bit 31~0 - rmem29[63:32] (Read/Write)
// 0x174 : reserved
// 0x178 : Data signal of wmem0
//         bit 31~0 - wmem0[31:0] (Read/Write)
// 0x17c : Data signal of wmem0
//         bit 31~0 - wmem0[63:32] (Read/Write)
// 0x180 : reserved
// 0x184 : Data signal of n
//         bit 31~0 - n[31:0] (Read/Write)
// 0x188 : Data signal of n
...
localparam
    ...
    ADDR_RMEM28_DATA_0 = 9'h160,
    ADDR_RMEM28_DATA_1 = 9'h164,
    ADDR_RMEM28_CTRL   = 9'h168,
    ADDR_RMEM29_DATA_0 = 9'h16c,
    ADDR_RMEM29_DATA_1 = 9'h170,
    ADDR_RMEM29_CTRL   = 9'h174,
    ADDR_WMEM0_DATA_0  = 9'h178,
    ADDR_WMEM0_DATA_1  = 9'h17c,
    ADDR_WMEM0_CTRL    = 9'h180,
    ADDR_N_DATA_0      = 9'h184,
    ADDR_N_DATA_1      = 9'h188,
    ADDR_N_CTRL        = 9'h18c,
    WRIDLE             = 2'd0,
    WRDATA             = 2'd1,
    WRRESP             = 2'd2,
...
//------------------------Local signal-------------------
    ...
    reg  [63:0]                   int_rmem28 = 'b0;
    reg  [63:0]                   int_rmem29 = 'b0;
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_RMEM28_DATA_0: begin
                    rdata <= int_rmem28[31:0];
                end
                ADDR_RMEM28_DATA_1: begin
                    rdata <= int_rmem28[63:32];
                end
                ADDR_RMEM29_DATA_0: begin
                    rdata <= int_rmem29[31:0];
                end
                ADDR_RMEM29_DATA_1: begin
                    rdata <= int_rmem29[63:32];
                end
...
assign rmem28            = int_rmem28;
assign rmem29            = int_rmem29;
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_RMEM28_DATA_0)
            int_rmem28[31:0] <= (WDATA[31:0] & wmask) | (int_rmem28[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_RMEM28_DATA_1)
            int_rmem28[63:32] <= (WDATA[31:0] & wmask) | (int_rmem28[63:32] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_RMEM29_DATA_0)
            int_rmem29[31:0] <= (WDATA[31:0] & wmask) | (int_rmem29[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_RMEM29_DATA_1)
            int_rmem29[63:32] <= (WDATA[31:0] & wmask) | (int_rmem29[63:32] & ~wmask);
    end
end
