...
//--------------------------------------------------------------------------------
//Command: generate_target bd_0004.bd
//Design : bd_0004
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
(* CORE_GENERATION_INFO = "bd_0004,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_0004,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=19,numReposBlks=15,numNonXlnxBlks=0,numHierBlks=4,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "design_1_smartconnect_31_0.hwdef" *)
module bd_0004
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface_v2sv_rpd:aximm:1.0 S00_AXI ARID" *) input [3:0]S00_AXI_arid;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface_v2sv_rpd:aximm:1.0 S00_AXI AWID" *) input [3:0]S00_AXI_awid;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface_v2sv_rpd:aximm:1.0 S00_AXI BID" *) output [3:0]S00_AXI_bid;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface_v2sv_rpd:aximm:1.0 S00_AXI RDATA" *) output [63:0]S00_AXI_rdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface_v2sv_rpd:aximm:1.0 S00_AXI RID" *) output [3:0]S00_AXI_rid;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface_v2sv_rpd:aximm:1.0 S00_AXI WDATA" *) input [63:0]S00_AXI_wdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface_v2sv_rpd:aximm:1.0 S00_AXI WSTRB" *) input [7:0]S00_AXI_wstrb;
  (* X_INTERFACE_INFO = "xilinx.com:interface_v2sv_rpd:aximm:1.0 S00_AXI WVALID" *) input S00_AXI_wvalid;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK, ASSOCIATED_BUSIF S00_AXI, ASSOCIATED_CLKEN m_sc_aclken, CLK_DOMAIN design_1_xdma_0_0_axi_aclk, FREQ_HZ 250000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input aclk;
  ...
  wire [303:0]s00_nodes_M_SC_W_PAYLD;
  ...
  m00_exit_pipeline_imp_1XA0JPY m00_exit_pipeline
       (.aclk(m_sc_clk_1),
  ...
  s00_entry_pipeline_imp_XZW3PX s00_entry_pipeline
       (.aclk(aclk_1),
        .aresetn(aresetn_2),
  ...
  s00_nodes_imp_UV6FV3 s00_nodes
