...
module rs_pipelined_kernel3_A_PE_dummy_14_A_PE_dummy_14_U0 #(
    ...
    input wire          ap_rst,
    input wire          ap_start,
    input wire  [255:0] fifo_A_PE_3_229_dout,
    input wire          fifo_A_PE_3_229_empty_n,
    input wire  [  1:0] fifo_A_PE_3_229_fifo_cap,
    input wire  [  1:0] fifo_A_PE_3_229_num_data_valid,
    output wire         fifo_A_PE_3_229_read
);

wire        rs_pipelined_ap_rst;


kernel3_A_PE_dummy_14 _ /**   design_1_i/kernel3_0/inst/A_PE_dummy_14_U0   **/ (
    .ap_clk                         (ap_clk),
    ...
    .ap_start                       (ap_start),
    .fifo_A_PE_3_229_dout           (fifo_A_PE_3_229_dout),
    .fifo_A_PE_3_229_empty_n        (fifo_A_PE_3_229_empty_n),
    .fifo_A_PE_3_229_fifo_cap       (fifo_A_PE_3_229_fifo_cap),
    .fifo_A_PE_3_229_num_data_valid (fifo_A_PE_3_229_num_data_valid),
    .fifo_A_PE_3_229_read           (fifo_A_PE_3_229_read)
);
...
endmodule  // rs_pipelined_kernel3_A_PE_dummy_14_A_PE_dummy_14_U0
