...
//--------------------------------------------------------------------------------
//Command: generate_target bd_fed5.bd
//Design : bd_fed5
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
(* CORE_GENERATION_INFO = "bd_fed5,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_fed5,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=19,numReposBlks=15,numNonXlnxBlks=0,numHierBlks=4,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "design_1_smartconnect_28_0.hwdef" *)
module bd_fed5
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
  ...
  m00_exit_pipeline_imp_1MXZ6LX m00_exit_pipeline
       (.aclk(m_sc_clk_1),
  ...
  s00_entry_pipeline_imp_O7R48M s00_entry_pipeline
       (.aclk(aclk_1),
        .aresetn(aresetn_2),
  ...
  s00_nodes_imp_IL7VHO s00_nodes
