...
module rs_pipelined_kernel3_A_PE_dummy_19_A_PE_dummy_19_U0 #(
    ...
    input wire          ap_rst,
    input wire          ap_start,
    input wire  [255:0] fifo_A_PE_8_244_dout,
    input wire          fifo_A_PE_8_244_empty_n,
    input wire  [  1:0] fifo_A_PE_8_244_fifo_cap,
    input wire  [  1:0] fifo_A_PE_8_244_num_data_valid,
    output wire         fifo_A_PE_8_244_read
);
...
kernel3_A_PE_dummy_19 _ /**   design_1_i/kernel3_0/inst/A_PE_dummy_19_U0   **/ (
    .ap_clk                         (ap_clk),
    ...
    .fifo_A_PE_8_244_dout           (fifo_A_PE_8_244_dout),
    .fifo_A_PE_8_244_empty_n        (fifo_A_PE_8_244_empty_n),
    .fifo_A_PE_8_244_fifo_cap       (fifo_A_PE_8_244_fifo_cap),
    .fifo_A_PE_8_244_num_data_valid (fifo_A_PE_8_244_num_data_valid),
    .fifo_A_PE_8_244_read           (fifo_A_PE_8_244_read)
);
...
endmodule  // rs_pipelined_kernel3_A_PE_dummy_19_A_PE_dummy_19_U0
