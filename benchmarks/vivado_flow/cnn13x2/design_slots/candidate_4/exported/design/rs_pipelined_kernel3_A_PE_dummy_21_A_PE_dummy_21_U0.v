...
module rs_pipelined_kernel3_A_PE_dummy_21_A_PE_dummy_21_U0 #(
    ...
    input wire          ap_rst,
    input wire          ap_start,
    input wire  [255:0] fifo_A_PE_10_250_dout,
    input wire          fifo_A_PE_10_250_empty_n,
    input wire  [  1:0] fifo_A_PE_10_250_fifo_cap,
    input wire  [  1:0] fifo_A_PE_10_250_num_data_valid,
    output wire         fifo_A_PE_10_250_read
);
...
kernel3_A_PE_dummy_21 _ /**   design_1_i/kernel3_0/inst/A_PE_dummy_21_U0   **/ (
    .ap_clk                          (ap_clk),
    ...
    .fifo_A_PE_10_250_dout           (fifo_A_PE_10_250_dout),
    .fifo_A_PE_10_250_empty_n        (fifo_A_PE_10_250_empty_n),
    .fifo_A_PE_10_250_fifo_cap       (fifo_A_PE_10_250_fifo_cap),
    .fifo_A_PE_10_250_num_data_valid (fifo_A_PE_10_250_num_data_valid),
    .fifo_A_PE_10_250_read           (fifo_A_PE_10_250_read)
);
...
endmodule  // rs_pipelined_kernel3_A_PE_dummy_21_A_PE_dummy_21_U0
