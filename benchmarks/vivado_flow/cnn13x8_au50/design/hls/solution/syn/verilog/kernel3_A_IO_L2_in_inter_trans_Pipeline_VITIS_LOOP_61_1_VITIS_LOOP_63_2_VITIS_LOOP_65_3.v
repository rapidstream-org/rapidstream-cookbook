...
module kernel3_A_IO_L2_in_inter_trans_Pipeline_VITIS_LOOP_61_1_VITIS_LOOP_63_2_VITIS_LOOP_65_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln1039_214_fu_196_p2;
reg   [0:0] icmp_ln1039_214_reg_417;
wire   [0:0] select_ln61_1_fu_214_p3;
reg   [0:0] select_ln61_1_reg_425_pp0_iter1_reg;
reg   [8:0] local_A_addr_reg_429;
reg   [255:0] fifo_data_reg_434;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [63:0] zext_ln70_1_fu_357_p1;
reg   [5:0] c5_V_fu_82;
wire   [5:0] add_ln840_313_fu_362_p2;
wire    ap_loop_init;
reg   [4:0] c4_V_fu_86;
wire   [4:0] select_ln1039_419_fu_339_p3;
reg   [10:0] indvar_flatten_fu_90;
wire   [10:0] select_ln1039_420_fu_236_p3;
reg   [10:0] ap_sig_allocacmp_indvar_flatten_load;
reg   [3:0] c3_V_fu_94;
wire   [3:0] select_ln1039_fu_222_p3;
reg   [3:0] ap_sig_allocacmp_c3_V_load;
reg   [12:0] indvar_flatten14_fu_98;
wire   [12:0] add_ln1039_105_fu_181_p2;
...
wire   [0:0] xor_ln61_fu_276_p2;
wire   [4:0] select_ln61_fu_269_p3;
wire   [4:0] add_ln840_312_fu_293_p2;
wire   [0:0] and_ln61_fu_287_p2;
wire   [0:0] or_ln1039_fu_303_p2;
wire   [3:0] trunc_ln61_fu_262_p1;
wire   [3:0] empty_876_fu_299_p1;
wire   [3:0] select_ln61_2_fu_316_p3;
wire   [3:0] select_ln70_fu_323_p3;
wire   [5:0] select_ln1039_418_fu_308_p3;
wire   [8:0] tmp_s_fu_331_p3;
wire   [8:0] zext_ln70_fu_347_p1;
wire   [8:0] add_ln70_fu_351_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            c4_V_fu_86 <= select_ln1039_419_fu_339_p3;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            c5_V_fu_82 <= add_ln840_313_fu_362_p2;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln1039_fu_175_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten14_fu_98 <= add_ln1039_105_fu_181_p2;
        end else if ((ap_loop_init == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln1039_fu_175_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            indvar_flatten_fu_90 <= select_ln1039_420_fu_236_p3;
        end else if ((ap_loop_init == 1'b1)) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        select_ln61_1_reg_425_pp0_iter1_reg <= select_ln61_1_reg_425;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln1039_reg_413 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        local_A_addr_reg_429 <= zext_ln70_1_fu_357_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln1039_fu_175_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        icmp_ln1039_214_reg_417 <= icmp_ln1039_214_fu_196_p2;
        select_ln61_1_reg_425 <= select_ln61_1_fu_214_p3;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (select_ln61_1_reg_425_pp0_iter1_reg == 1'd1))) begin
        local_A_we1 = 1'b1;
    end else begin
        local_A_we1 = 1'b0;
    end
...
assign add_ln1039_105_fu_181_p2 = (ap_sig_allocacmp_indvar_flatten14_load + 13'd1);

assign add_ln1039_fu_230_p2 = (ap_sig_allocacmp_indvar_flatten_load + 11'd1);

assign add_ln70_fu_351_p2 = (tmp_s_fu_331_p3 + zext_ln70_fu_347_p1);

assign add_ln840_312_fu_293_p2 = (select_ln61_fu_269_p3 + 5'd1);

assign add_ln840_313_fu_362_p2 = (select_ln1039_418_fu_308_p3 + 6'd1);

assign add_ln840_fu_190_p2 = (ap_sig_allocacmp_c3_V_load + 4'd1);

assign and_ln61_fu_287_p2 = (xor_ln61_fu_276_p2 & icmp_ln103911_fu_281_p2);
...
always @ (*) begin
    ap_predicate_op65_write_state2 = ((select_ln61_1_reg_425 == 1'd0) & (icmp_ln1039_reg_413 == 1'd0));
end
...
assign empty_876_fu_299_p1 = add_ln840_312_fu_293_p2[3:0];

assign fifo_A_A_IO_L2_in_1215_din = fifo_A_A_IO_L2_in_111411_dout;

assign icmp_ln103911_fu_281_p2 = ((c5_V_fu_82 == 6'd32) ? 1'b1 : 1'b0);

assign icmp_ln1039_214_fu_196_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 11'd512) ? 1'b1 : 1'b0);
...
assign or_ln1039_fu_303_p2 = (icmp_ln1039_214_reg_417 | and_ln61_fu_287_p2);

assign select_ln1039_418_fu_308_p3 = ((or_ln1039_fu_303_p2[0:0] == 1'b1) ? 6'd0 : c5_V_fu_82);

assign select_ln1039_419_fu_339_p3 = ((and_ln61_fu_287_p2[0:0] == 1'b1) ? add_ln840_312_fu_293_p2 : select_ln61_fu_269_p3);

assign select_ln1039_420_fu_236_p3 = ((icmp_ln1039_214_fu_196_p2[0:0] == 1'b1) ? 11'd1 : add_ln1039_fu_230_p2);

assign select_ln1039_fu_222_p3 = ((icmp_ln1039_214_fu_196_p2[0:0] == 1'b1) ? add_ln840_fu_190_p2 : ap_sig_allocacmp_c3_V_load);

assign select_ln61_1_fu_214_p3 = ((icmp_ln1039_214_fu_196_p2[0:0] == 1'b1) ? cmp_i_i_mid1_fu_202_p2 : cmp_i_i3_fu_208_p2);

assign select_ln61_2_fu_316_p3 = ((icmp_ln1039_214_reg_417[0:0] == 1'b1) ? 4'd0 : trunc_ln61_fu_262_p1);

assign select_ln61_fu_269_p3 = ((icmp_ln1039_214_reg_417[0:0] == 1'b1) ? 5'd0 : c4_V_fu_86);

assign select_ln70_fu_323_p3 = ((and_ln61_fu_287_p2[0:0] == 1'b1) ? empty_876_fu_299_p1 : select_ln61_2_fu_316_p3);

assign tmp_s_fu_331_p3 = {{select_ln70_fu_323_p3}, {5'd0}};

assign trunc_ln61_fu_262_p1 = c4_V_fu_86[3:0];

assign xor_ln61_fu_276_p2 = (icmp_ln1039_214_reg_417 ^ 1'd1);

assign zext_ln70_1_fu_357_p1 = add_ln70_fu_351_p2;

assign zext_ln70_fu_347_p1 = select_ln1039_418_fu_308_p3;

endmodule //kernel3_A_IO_L2_in_inter_trans_Pipeline_VITIS_LOOP_61_1_VITIS_LOOP_63_2_VITIS_LOOP_65_3
