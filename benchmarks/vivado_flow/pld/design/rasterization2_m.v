...
(* CORE_GENERATION_INFO="rasterization2_m_rasterization2_m,hls_ip_2021_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu9eg-ffvb1156-2-e,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.385000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=8,HLS_SYN_DSP=0,HLS_SYN_FF=4542,HLS_SYN_LUT=4638,HLS_VERSION=2021_1}" *)
...
wire    Output_4_V_TREADY_int_regslice;
wire    regslice_both_Output_4_V_U_vld_out;
wire    ap_ce_reg;
...
regslice_both_Output_4_V_U(
    ...
    .ack_out(Output_4_V_TREADY),
    .apdone_blk(regslice_both_Output_4_V_U_apdone_blk)
);
...
always @ (*) begin
    if (((regslice_both_Output_4_V_U_apdone_blk == 1'b1) | (regslice_both_Output_3_V_U_apdone_blk == 1'b1) | (regslice_both_Output_2_V_U_apdone_blk == 1'b1) | (regslice_both_Output_1_V_U_apdone_blk == 1'b1))) begin
...
always @ (*) begin
    if ((~((regslice_both_Output_4_V_U_apdone_blk == 1'b1) | (regslice_both_Output_3_V_U_apdone_blk == 1'b1) | (regslice_both_Output_2_V_U_apdone_blk == 1'b1) | (regslice_both_Output_1_V_U_apdone_blk == 1'b1)) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
assign Output_4_V_TVALID = regslice_both_Output_4_V_U_vld_out;
...
always @ (*) begin
    ap_block_state4 = ((regslice_both_Output_4_V_U_apdone_blk == 1'b1) | (regslice_both_Output_3_V_U_apdone_blk == 1'b1) | (regslice_both_Output_2_V_U_apdone_blk == 1'b1) | (regslice_both_Output_1_V_U_apdone_blk == 1'b1));
end
