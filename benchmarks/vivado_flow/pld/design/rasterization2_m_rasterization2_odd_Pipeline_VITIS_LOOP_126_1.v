...
module rasterization2_m_rasterization2_odd_Pipeline_VITIS_LOOP_126_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [31:0] add_ln117;
input  [31:0] add_ln120;
...
reg   [7:0] fragment_y_V_load_reg_309;
reg   [15:0] j_fu_62;
wire    ap_loop_init;
reg   [15:0] ap_sig_allocacmp_j_1;
wire   [15:0] add_ln126_fu_182_p2;
reg   [31:0] empty_fu_66;
wire   [31:0] add_ln144_fu_230_p2;
reg   [31:0] empty_11_fu_70;
wire   [31:0] add_ln135_fu_250_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        fragment_y_V_load_reg_309 <= fragment_y_V_q0;
        tmp_reg_324 <= fragment_y_V_q0[32'd7];
    end
end
...
assign Output_1_V_TDATA = zext_ln414_fu_221_p1;

assign Output_2_V_TDATA = zext_ln414_fu_221_p1;

assign add_ln126_fu_182_p2 = (ap_sig_allocacmp_j_1 + 16'd1);

assign add_ln135_fu_250_p2 = (empty_11_fu_70 + 32'd1);

assign add_ln144_fu_230_p2 = (empty_fu_66 + 32'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter2 == 1'b1) & (((tmp_reg_324 == 1'd1) & (1'b0 == Output_1_V_TREADY)) | ((tmp_reg_324 == 1'd0) & (1'b0 == Output_2_V_TREADY))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter2 == 1'b1) & ((1'b1 == ap_block_state3_io) | ((tmp_reg_324 == 1'd1) & (1'b0 == Output_1_V_TREADY)) | ((tmp_reg_324 == 1'd0) & (1'b0 == Output_2_V_TREADY))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter2 == 1'b1) & ((1'b1 == ap_block_state3_io) | ((tmp_reg_324 == 1'd1) & (1'b0 == Output_1_V_TREADY)) | ((tmp_reg_324 == 1'd0) & (1'b0 == Output_2_V_TREADY))));
end
...
always @ (*) begin
    ap_block_state3_io = (((tmp_reg_324 == 1'd1) & (1'b0 == Output_1_V_TREADY)) | ((tmp_reg_324 == 1'd0) & (1'b0 == Output_2_V_TREADY)));
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = (((tmp_reg_324 == 1'd1) & (1'b0 == Output_1_V_TREADY)) | ((tmp_reg_324 == 1'd0) & (1'b0 == Output_2_V_TREADY)));
end
...
assign fragment_color_V_address0 = zext_ln1057_reg_292;

assign fragment_x_V_address0 = zext_ln1057_reg_292;

assign fragment_y_V_address0 = zext_ln1057_fu_188_p1;

assign fragment_z_V_address0 = zext_ln1057_reg_292;

assign icmp_ln1057_fu_176_p2 = ((ap_sig_allocacmp_j_1 == i_V_reload) ? 1'b1 : 1'b0);

assign out1_cnt = (empty_11_fu_70 + 32'd1);

assign out2_cnt = (empty_fu_66 + 32'd1);

assign out_tmp_V_fu_206_p5 = {{{{fragment_color_V_q0}, {fragment_z_V_q0}}, {fragment_y_V_load_reg_309}}, {fragment_x_V_q0}};

assign sext_ln414_fu_217_p1 = $signed(out_tmp_V_fu_206_p5);

assign zext_ln1057_fu_188_p1 = ap_sig_allocacmp_j_1;
...
endmodule //rasterization2_m_rasterization2_odd_Pipeline_VITIS_LOOP_126_1
