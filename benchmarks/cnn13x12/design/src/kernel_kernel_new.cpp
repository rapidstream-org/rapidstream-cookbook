...
#pragma HLS INLINE OFF
    ...
    for (ap_uint<5> c3 = p0; c3 <= 11; c3 += 1) {
      // io_L2
...
#pragma HLS INTERFACE m_axi port=B offset=slave bundle=gmem_B depth=196608/16
#pragma HLS INTERFACE m_axi port=C offset=slave bundle=gmem_C depth=159744/16
