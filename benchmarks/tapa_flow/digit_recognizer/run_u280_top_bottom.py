...
factory = DeviceFactory(row=2, col=1, part_num="xcu280-fsvh2892-2L-e", board_name=None)
factory.set_user_pblock_name("pblock_dynamic_region")
factory.set_slot_pblock(
    0, 0, U280_LOWER2SLOTS + ["-remove CLOCKREGION_X0Y4:CLOCKREGION_X7Y7"]
)
factory.set_slot_pblock(
    0, 1, U280_LOWER2SLOTS + ["-remove CLOCKREGION_X0Y0:CLOCKREGION_X7Y3"]
)
