...
module vecp_mux_vecp_mux_Pipeline_q2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] tmp_4_nbreadreq_fu_56_p3;
...
always @ (*) begin
    if (((1'd1 == and_ln131_fu_103_p2) & (q_in2_s_empty_n == 1'b1) & (icmp_ln128_fu_97_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        q_in2_s_read = 1'b1;
    end else begin
        q_in2_s_read = 1'b0;
    end
...
assign and_ln131_fu_103_p2 = (tmp_4_nbreadreq_fu_56_p3 & and_ln131_fu_103_p1);
...
assign icmp_ln128_fu_97_p2 = (($signed(ap_sig_allocacmp_i_1) < $signed(sext_ln451_cast_fu_85_p1)) ? 1'b1 : 1'b0);

assign q_out_din = {{1'd0}, {trunc_ln146_fu_113_p1}};

assign sext_ln451_cast_fu_85_p1 = $signed(sext_ln451);

assign tmp_4_nbreadreq_fu_56_p3 = q_in2_s_empty_n;

assign trunc_ln146_fu_113_p1 = q_in2_s_dout[511:0];

endmodule //vecp_mux_vecp_mux_Pipeline_q2
