...
module ctrl_R_ctrl_R_Pipeline_qq (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire  signed [31:0] sext_ln403_cast_fu_210_p1;
...
ctrl_R_flow_control_loop_pipe_sequential_init flow_control_loop_pipe_sequential_init_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(ap_start),
    .ap_ready(ap_ready),
...
always @ (*) begin
    if (((1'd1 == and_ln184_fu_228_p2) & (qr_from_pe_s_empty_n == 1'b1) & (icmp_ln181_fu_222_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        qr_from_pe_s_read = 1'b1;
    end else begin
...
always @ (*) begin
    if (((1'd1 == and_ln190_fu_263_p2) & (qr_to_pe_full_n == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        qr_to_pe_write = 1'b1;
    end else begin
        qr_to_pe_write = 1'b0;
    end
...
assign and_ln190_fu_263_p1 = qr_to_pe_full_n;
...
assign icmp_ln181_fu_222_p2 = (($signed(ap_sig_allocacmp_i_1) < $signed(sext_ln403_cast_fu_210_p1)) ? 1'b1 : 1'b0);
...
assign qr_to_pe_din = {{1'd0}, {tmp_8_fu_315_p4}};

assign sext_ln403_cast_fu_210_p1 = $signed(sext_ln403);
...
assign tmp_s_nbreadreq_fu_92_p3 = qr_from_pe_s_empty_n;

assign trunc_ln146_fu_238_p1 = qr_from_pe_s_dout[511:0];
...
endmodule //ctrl_R_ctrl_R_Pipeline_qq
