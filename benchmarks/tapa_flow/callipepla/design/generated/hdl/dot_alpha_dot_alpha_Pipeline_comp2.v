...
module dot_alpha_dot_alpha_Pipeline_comp2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] tmp_s_fu_232_p10;
reg   [63:0] tmp_s_reg_315;
reg   [63:0] psum_load_reg_320;
wire   [63:0] zext_ln428_fu_220_p1;
...
dot_alpha_mul_6ns_8ns_13_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 6 ),
    .din1_WIDTH( 8 ),
    .dout_WIDTH( 13 ))
mul_6ns_8ns_13_1_1_U40(
    .din0(mul2_fu_187_p0),
    .din1(mul2_fu_187_p1),
    .dout(mul2_fu_187_p2)
);

dot_alpha_urem_6ns_4ns_6_10_1 #(
    .ID( 1 ),
    .NUM_STAGE( 10 ),
    .din0_WIDTH( 6 ),
    .din1_WIDTH( 4 ),
    .dout_WIDTH( 6 ))
urem_6ns_4ns_6_10_1_U41(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln425_fu_177_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        psum_addr_1_reg_309 <= zext_ln428_fu_220_p1;
        ...
        tmp_s_reg_315 <= tmp_s_fu_232_p10;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln425_fu_177_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        trunc_ln1_reg_269 <= {{mul2_fu_187_p2[11:9]}};
    end
end

always @ (*) begin
    if (((icmp_ln425_fu_177_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign grp_fu_540_p_din0 = psum_load_reg_320;

assign grp_fu_540_p_din1 = tmp_s_reg_315;

assign grp_fu_540_p_opcode = 2'd0;

assign i_3_fu_209_p2 = (ap_sig_allocacmp_i + 6'd1);

assign icmp_ln425_fu_177_p2 = ((ap_sig_allocacmp_i == 6'd56) ? 1'b1 : 1'b0);
...
assign psum_1_address0 = zext_ln428_fu_220_p1;

assign psum_2_address0 = zext_ln428_fu_220_p1;

assign psum_3_address0 = zext_ln428_fu_220_p1;

assign psum_4_address0 = zext_ln428_fu_220_p1;

assign psum_5_address0 = zext_ln428_fu_220_p1;

assign psum_6_address0 = zext_ln428_fu_220_p1;

assign psum_7_address0 = zext_ln428_fu_220_p1;

assign psum_address0 = psum_addr_1_reg_309_pp0_iter14_reg;

assign psum_address1 = zext_ln428_fu_220_p1;

assign psum_d0 = grp_fu_540_p_dout0;

assign zext_ln428_fu_220_p1 = grp_fu_193_p2;

endmodule //dot_alpha_dot_alpha_Pipeline_comp2
