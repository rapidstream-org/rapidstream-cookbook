...
void Knn(
    ...
    tapa::streams<float, 27, TOP> L0_out_dist;
    tapa::streams<int, 27, TOP> L0_out_id;
    tapa::streams<float, 13, 2> L1_out_dist;
    tapa::streams<int, 13, 2> L1_out_id;
    tapa::streams<float, 6, 2> L2_out_dist;
    tapa::streams<int, 6, 2> L2_out_id;
    tapa::streams<float, 3, 2> L3_out_dist;
    tapa::streams<int, 3, 2> L3_out_id;
    // Streams, for load->compute->sort:
    tapa::streams<ap_uint<IWIDTH>, (27), 2> load_to_compute_stream;
    ...
    tapa::streams<float, (L2I_FACTOR_W * 2), 2> compute_to_sort_stream_15;
    tapa::streams<float, (L2I_FACTOR_W * 2), 2> compute_to_sort_stream_16;
    tapa::streams<float, (L2I_FACTOR_W * 2), 2> compute_to_sort_stream_17;
    tapa::streams<float, (L2I_FACTOR_W * 2), 2> compute_to_sort_stream_18;
    tapa::streams<float, (L2I_FACTOR_W * 2), 2> compute_to_sort_stream_19;
    tapa::streams<float, (L2I_FACTOR_W * 2), 2> compute_to_sort_stream_20;
    tapa::streams<float, (L2I_FACTOR_W * 2), 2> compute_to_sort_stream_21;
    tapa::streams<float, (L2I_FACTOR_W * 2), 2> compute_to_sort_stream_22;
    tapa::streams<float, (L2I_FACTOR_W * 2), 2> compute_to_sort_stream_23;
    tapa::streams<float, (L2I_FACTOR_W * 2), 2> compute_to_sort_stream_24;
    tapa::streams<float, (L2I_FACTOR_W * 2), 2> compute_to_sort_stream_25;
    tapa::streams<float, (L2I_FACTOR_W * 2), 2> compute_to_sort_stream_26;
    ...
    tapa::streams<float, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_dist_stream_15;
    tapa::streams<int, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_id_stream_15;
    tapa::streams<float, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_dist_stream_16;
    tapa::streams<int, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_id_stream_16;
    tapa::streams<float, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_dist_stream_17;
    tapa::streams<int, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_id_stream_17;
    tapa::streams<float, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_dist_stream_18;
    tapa::streams<int, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_id_stream_18;
    tapa::streams<float, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_dist_stream_19;
    tapa::streams<int, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_id_stream_19;
    tapa::streams<float, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_dist_stream_20;
    tapa::streams<int, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_id_stream_20;
    tapa::streams<float, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_dist_stream_21;
    tapa::streams<int, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_id_stream_21;
    tapa::streams<float, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_dist_stream_22;
    tapa::streams<int, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_id_stream_22;
    tapa::streams<float, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_dist_stream_23;
    tapa::streams<int, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_id_stream_23;
    tapa::streams<float, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_dist_stream_24;
    tapa::streams<int, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_id_stream_24;
    tapa::streams<float, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_dist_stream_25;
    tapa::streams<int, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_id_stream_25;
    tapa::streams<float, (L2I_FACTOR_W * 2)*D2L_FACTOR_W, TOP> sort_to_hiermerge_dist_stream_26;
    ...
    tapa::task()
        ...
        .invoke( compute_KNN, 0, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*0, load_to_compute_stream[0 ], compute_to_sort_stream_0 )
        .invoke( compute_KNN, 1, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*1, load_to_compute_stream[1 ], compute_to_sort_stream_1 )
        .invoke( compute_KNN, 2, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*2, load_to_compute_stream[2 ], compute_to_sort_stream_2 )
        .invoke( compute_KNN, 3, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*3, load_to_compute_stream[3 ], compute_to_sort_stream_3 )
        .invoke( compute_KNN, 4, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*4, load_to_compute_stream[4 ], compute_to_sort_stream_4 )
        .invoke( compute_KNN, 5, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*5, load_to_compute_stream[5 ], compute_to_sort_stream_5 )
        .invoke( compute_KNN, 6, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*6, load_to_compute_stream[6 ], compute_to_sort_stream_6 )
        .invoke( compute_KNN, 7, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*7, load_to_compute_stream[7 ], compute_to_sort_stream_7 )
        .invoke( compute_KNN, 8, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*8, load_to_compute_stream[8 ], compute_to_sort_stream_8 )
        .invoke( compute_KNN, 9, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*9, load_to_compute_stream[9 ], compute_to_sort_stream_9 )
        .invoke( compute_KNN, 10, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*10, load_to_compute_stream[10 ], compute_to_sort_stream_10 )
        .invoke( compute_KNN, 11, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*11, load_to_compute_stream[11 ], compute_to_sort_stream_11 )
        .invoke( compute_KNN, 12, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*12, load_to_compute_stream[12 ], compute_to_sort_stream_12 )
        .invoke( compute_KNN, 13, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*13, load_to_compute_stream[13 ], compute_to_sort_stream_13 )
        .invoke( compute_KNN, 14, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*14, load_to_compute_stream[14 ], compute_to_sort_stream_14 )
        .invoke( compute_KNN, 15, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*15, load_to_compute_stream[15 ], compute_to_sort_stream_15 )
        .invoke( compute_KNN, 16, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*16, load_to_compute_stream[16 ], compute_to_sort_stream_16 )
        .invoke( compute_KNN, 17, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*17, load_to_compute_stream[17 ], compute_to_sort_stream_17 )
        .invoke( compute_KNN, 18, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*18, load_to_compute_stream[18 ], compute_to_sort_stream_18 )
        .invoke( compute_KNN, 19, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*19, load_to_compute_stream[19 ], compute_to_sort_stream_19 )
        .invoke( compute_KNN, 20, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*20, load_to_compute_stream[20 ], compute_to_sort_stream_20 )
        .invoke( compute_KNN, 21, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*21, load_to_compute_stream[21 ], compute_to_sort_stream_21 )
        .invoke( compute_KNN, 22, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*22, load_to_compute_stream[22 ], compute_to_sort_stream_22 )
        .invoke( compute_KNN, 23, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*23, load_to_compute_stream[23 ], compute_to_sort_stream_23 )
        .invoke( compute_KNN, 24, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*24, load_to_compute_stream[24 ], compute_to_sort_stream_24 )
        .invoke( compute_KNN, 25, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*25, load_to_compute_stream[25 ], compute_to_sort_stream_25 )
        .invoke( compute_KNN, 26, (( (( ((4194304)-1)/(27) + 1 )-1)/((L2I_FACTOR_W * 2)*D2I_FACTOR_W) + 1 ) * ((L2I_FACTOR_W * 2)*D2I_FACTOR_W))*26, load_to_compute_stream[26 ], compute_to_sort_stream_26 )
        ...
        .invoke( merge_trio_streams, -1, 24, -1, L0_out_dist[24], L0_out_id[24], L0_out_dist[25], L0_out_id[25], L0_out_dist[26], L0_out_id[26], L1_out_dist[12], L1_out_id[12] )
        ...
        .invoke( merge_trio_streams, -1, 10, 0, L1_out_dist[10], L1_out_id[10], L1_out_dist[11], L1_out_id[11], L1_out_dist[12], L1_out_id[12], L2_out_dist[5], L2_out_id[5] )
        ...
        .invoke( merge_dual_streams, -1, 4, 1, L2_out_dist[4], L2_out_id[4], L2_out_dist[5], L2_out_id[5], L3_out_dist[2], L3_out_id[2] )
