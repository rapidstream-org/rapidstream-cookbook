        ...
        for (int ii = 0 ; ii < NUM_SEGMENTS; ++ii){
            ...
            #pragma HLS UNROLL
                ...
                #pragma HLS UNROLL
                    ...
                    int dist_range_idx = d2l * DATA_TYPE_TOTAL_SZ;
                   ...
                   aggregated_local_dists.range(dist_range_idx + (DATA_TYPE_TOTAL_SZ - 1),
                                                dist_range_idx)
                       = delta_squared_sum.range(DATA_TYPE_TOTAL_SZ - 1, 0);
...
#pragma HLS INLINE OFF
    ...
    #pragma HLS PIPELINE II=2
        ...
        if (lvalue_idx >= SEGMENT_SIZE_IN_L) {
            ...
            {
                DATA_TYPE cur_Dval = MAX_DATA_TYPE_VAL;
                cur_Lval.range(DATA_TYPE_TOTAL_SZ*(D_idx+1) - 1, DATA_TYPE_TOTAL_SZ*(D_idx)) =
                    cur_Dval.range(DATA_TYPE_TOTAL_SZ-1, 0);
            }
        } else {
            //#ifndef __SYNTHESIS__
            //if (PE_idx == 0)
        ...
        #pragma HLS UNROLL
            ...
            cur_Dval.range(DATA_TYPE_TOTAL_SZ - 1, 0) =
                cur_Lval.range(range_idx + (DATA_TYPE_TOTAL_SZ - 1), range_idx);
...
void write_out_mmap(
                    tapa::async_mmap<INT32>&    output_knnDist,
...
#pragma HLS INLINE
    INT32 output_dist_32bit = 0;
    output_dist_32bit.range(DATA_TYPE_TOTAL_SZ - 1, 0) = output_dist.range(DATA_TYPE_TOTAL_SZ - 1, 0);
...
void merge_dual_streams_FINAL(
                        ...
                        tapa::istream<DATA_TYPE>&   hiermerge_dist_istream_2,
                        tapa::istream<int>&         hiermerge_id_istream_2,
                        tapa::async_mmap<INT32>&    hiermerge_dist_output,
...
void Knn(
    ...
    tapa::mmap<INT32> final_out_dist,
    tapa::mmap<int> final_out_id
) {

    // Streams, for the global merge:
    tapa::streams<DATA_TYPE, 30, TOP> L0_out_dist;
    tapa::streams<int,       30, TOP> L0_out_id;
    tapa::streams<DATA_TYPE, 15, 2>   L1_out_dist;
    tapa::streams<int,       15, 2>   L1_out_id;
    tapa::streams<DATA_TYPE, 7, 2>   L2_out_dist;
    tapa::streams<int,       7, 2>   L2_out_id;
    tapa::streams<DATA_TYPE, 3, 2>   L3_out_dist;
    ...
    tapa::streams<LOCAL_DIST_DTYPE, NUM_SEGMENTS, 2>    compute_to_sort_stream_15;
    tapa::streams<LOCAL_DIST_DTYPE, NUM_SEGMENTS, 2>    compute_to_sort_stream_16;
    tapa::streams<LOCAL_DIST_DTYPE, NUM_SEGMENTS, 2>    compute_to_sort_stream_17;
    tapa::streams<LOCAL_DIST_DTYPE, NUM_SEGMENTS, 2>    compute_to_sort_stream_18;
    tapa::streams<LOCAL_DIST_DTYPE, NUM_SEGMENTS, 2>    compute_to_sort_stream_19;
    tapa::streams<LOCAL_DIST_DTYPE, NUM_SEGMENTS, 2>    compute_to_sort_stream_20;
    tapa::streams<LOCAL_DIST_DTYPE, NUM_SEGMENTS, 2>    compute_to_sort_stream_21;
    tapa::streams<LOCAL_DIST_DTYPE, NUM_SEGMENTS, 2>    compute_to_sort_stream_22;
    tapa::streams<LOCAL_DIST_DTYPE, NUM_SEGMENTS, 2>    compute_to_sort_stream_23;
    tapa::streams<LOCAL_DIST_DTYPE, NUM_SEGMENTS, 2>    compute_to_sort_stream_24;
    tapa::streams<LOCAL_DIST_DTYPE, NUM_SEGMENTS, 2>    compute_to_sort_stream_25;
    tapa::streams<LOCAL_DIST_DTYPE, NUM_SEGMENTS, 2>    compute_to_sort_stream_26;
    tapa::streams<LOCAL_DIST_DTYPE, NUM_SEGMENTS, 2>    compute_to_sort_stream_27;
    tapa::streams<LOCAL_DIST_DTYPE, NUM_SEGMENTS, 2>    compute_to_sort_stream_28;
    tapa::streams<LOCAL_DIST_DTYPE, NUM_SEGMENTS, 2>    compute_to_sort_stream_29;
    ...
    tapa::streams<DATA_TYPE, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                 sort_to_hiermerge_dist_stream_15;
    tapa::streams<int, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                       sort_to_hiermerge_id_stream_15;
    tapa::streams<DATA_TYPE, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                 sort_to_hiermerge_dist_stream_16;
    tapa::streams<int, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                       sort_to_hiermerge_id_stream_16;
    tapa::streams<DATA_TYPE, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                 sort_to_hiermerge_dist_stream_17;
    tapa::streams<int, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                       sort_to_hiermerge_id_stream_17;
    tapa::streams<DATA_TYPE, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                 sort_to_hiermerge_dist_stream_18;
    tapa::streams<int, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                       sort_to_hiermerge_id_stream_18;
    tapa::streams<DATA_TYPE, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                 sort_to_hiermerge_dist_stream_19;
    tapa::streams<int, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                       sort_to_hiermerge_id_stream_19;
    tapa::streams<DATA_TYPE, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                 sort_to_hiermerge_dist_stream_20;
    tapa::streams<int, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                       sort_to_hiermerge_id_stream_20;
    tapa::streams<DATA_TYPE, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                 sort_to_hiermerge_dist_stream_21;
    tapa::streams<int, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                       sort_to_hiermerge_id_stream_21;
    tapa::streams<DATA_TYPE, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                 sort_to_hiermerge_dist_stream_22;
    tapa::streams<int, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                       sort_to_hiermerge_id_stream_22;
    tapa::streams<DATA_TYPE, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                 sort_to_hiermerge_dist_stream_23;
    tapa::streams<int, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                       sort_to_hiermerge_id_stream_23;
    tapa::streams<DATA_TYPE, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                 sort_to_hiermerge_dist_stream_24;
    tapa::streams<int, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                       sort_to_hiermerge_id_stream_24;
    tapa::streams<DATA_TYPE, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                 sort_to_hiermerge_dist_stream_25;
    tapa::streams<int, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                       sort_to_hiermerge_id_stream_25;
    tapa::streams<DATA_TYPE, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                 sort_to_hiermerge_dist_stream_26;
    tapa::streams<int, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                       sort_to_hiermerge_id_stream_26;
    tapa::streams<DATA_TYPE, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                 sort_to_hiermerge_dist_stream_27;
    tapa::streams<int, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                       sort_to_hiermerge_id_stream_27;
    tapa::streams<DATA_TYPE, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                 sort_to_hiermerge_dist_stream_28;
    tapa::streams<int, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                       sort_to_hiermerge_id_stream_28;
    tapa::streams<DATA_TYPE, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                 sort_to_hiermerge_dist_stream_29;
    tapa::streams<int, NUM_SEGMENTS*D2L_FACTOR_W, TOP>                       sort_to_hiermerge_id_stream_29;
    ...
    HIERMERGE_STREAM_DECLS(15)
    HIERMERGE_STREAM_DECLS(16)
    HIERMERGE_STREAM_DECLS(17)
    HIERMERGE_STREAM_DECLS(18)
    HIERMERGE_STREAM_DECLS(19)
    HIERMERGE_STREAM_DECLS(20)
    HIERMERGE_STREAM_DECLS(21)
    HIERMERGE_STREAM_DECLS(22)
    HIERMERGE_STREAM_DECLS(23)
    HIERMERGE_STREAM_DECLS(24)
    HIERMERGE_STREAM_DECLS(25)
    HIERMERGE_STREAM_DECLS(26)
    HIERMERGE_STREAM_DECLS(27)
    HIERMERGE_STREAM_DECLS(28)
    HIERMERGE_STREAM_DECLS(29)
    ...
    tapa::task()
        ...
        .invoke( compute_KNN, 15, NUM_SP_PTS_PER_KRNL_PADDED*15, load_to_compute_stream[15 ], compute_to_sort_stream_15  )
        .invoke( compute_KNN, 16, NUM_SP_PTS_PER_KRNL_PADDED*16, load_to_compute_stream[16 ], compute_to_sort_stream_16  )
        .invoke( compute_KNN, 17, NUM_SP_PTS_PER_KRNL_PADDED*17, load_to_compute_stream[17 ], compute_to_sort_stream_17  )
        .invoke( compute_KNN, 18, NUM_SP_PTS_PER_KRNL_PADDED*18, load_to_compute_stream[18 ], compute_to_sort_stream_18  )
        .invoke( compute_KNN, 19, NUM_SP_PTS_PER_KRNL_PADDED*19, load_to_compute_stream[19 ], compute_to_sort_stream_19  )
        .invoke( compute_KNN, 20, NUM_SP_PTS_PER_KRNL_PADDED*20, load_to_compute_stream[20 ], compute_to_sort_stream_20  )
        .invoke( compute_KNN, 21, NUM_SP_PTS_PER_KRNL_PADDED*21, load_to_compute_stream[21 ], compute_to_sort_stream_21  )
        .invoke( compute_KNN, 22, NUM_SP_PTS_PER_KRNL_PADDED*22, load_to_compute_stream[22 ], compute_to_sort_stream_22  )
        .invoke( compute_KNN, 23, NUM_SP_PTS_PER_KRNL_PADDED*23, load_to_compute_stream[23 ], compute_to_sort_stream_23  )
        .invoke( compute_KNN, 24, NUM_SP_PTS_PER_KRNL_PADDED*24, load_to_compute_stream[24 ], compute_to_sort_stream_24  )
        .invoke( compute_KNN, 25, NUM_SP_PTS_PER_KRNL_PADDED*25, load_to_compute_stream[25 ], compute_to_sort_stream_25  )
        .invoke( compute_KNN, 26, NUM_SP_PTS_PER_KRNL_PADDED*26, load_to_compute_stream[26 ], compute_to_sort_stream_26  )
        .invoke( compute_KNN, 27, NUM_SP_PTS_PER_KRNL_PADDED*27, load_to_compute_stream[27 ], compute_to_sort_stream_27  )
        .invoke( compute_KNN, 28, NUM_SP_PTS_PER_KRNL_PADDED*28, load_to_compute_stream[28 ], compute_to_sort_stream_28  )
        .invoke( compute_KNN, 29, NUM_SP_PTS_PER_KRNL_PADDED*29, load_to_compute_stream[29 ], compute_to_sort_stream_29  )
        ...
        INVOKE_PPS_UNITS_FOR_PE(15)
        INVOKE_PPS_UNITS_FOR_PE(16)
        INVOKE_PPS_UNITS_FOR_PE(17)
        INVOKE_PPS_UNITS_FOR_PE(18)
        INVOKE_PPS_UNITS_FOR_PE(19)
        INVOKE_PPS_UNITS_FOR_PE(20)
        INVOKE_PPS_UNITS_FOR_PE(21)
        INVOKE_PPS_UNITS_FOR_PE(22)
        INVOKE_PPS_UNITS_FOR_PE(23)
        INVOKE_PPS_UNITS_FOR_PE(24)
        INVOKE_PPS_UNITS_FOR_PE(25)
        INVOKE_PPS_UNITS_FOR_PE(26)
        INVOKE_PPS_UNITS_FOR_PE(27)
        INVOKE_PPS_UNITS_FOR_PE(28)
        INVOKE_PPS_UNITS_FOR_PE(29)
        ...
        INVOKE_HIERMERGE_UNITS_FOR_PE(15)
        INVOKE_HIERMERGE_UNITS_FOR_PE(16)
        INVOKE_HIERMERGE_UNITS_FOR_PE(17)
        INVOKE_HIERMERGE_UNITS_FOR_PE(18)
        INVOKE_HIERMERGE_UNITS_FOR_PE(19)
        INVOKE_HIERMERGE_UNITS_FOR_PE(20)
        INVOKE_HIERMERGE_UNITS_FOR_PE(21)
        INVOKE_HIERMERGE_UNITS_FOR_PE(22)
        INVOKE_HIERMERGE_UNITS_FOR_PE(23)
        INVOKE_HIERMERGE_UNITS_FOR_PE(24)
        INVOKE_HIERMERGE_UNITS_FOR_PE(25)
        INVOKE_HIERMERGE_UNITS_FOR_PE(26)
        INVOKE_HIERMERGE_UNITS_FOR_PE(27)
        INVOKE_HIERMERGE_UNITS_FOR_PE(28)
        INVOKE_HIERMERGE_UNITS_FOR_PE(29)
