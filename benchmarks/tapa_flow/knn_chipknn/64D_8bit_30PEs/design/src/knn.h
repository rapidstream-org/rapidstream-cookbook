...
#define DATA_TYPE_INT_PART_SZ 3 // NOTE: This includes the sign bit, if applicable.
#define DATA_TYPE_TOTAL_SZ    8
#define DATA_TYPE ap_fixed<DATA_TYPE_TOTAL_SZ, DATA_TYPE_INT_PART_SZ, \
                                AP_RND, AP_SAT>

// Datapacking compute's output & sort's input
#define LOCAL_DIST_SZ   (8)
...
#define MAX_DATA_TYPE_VAL (3.96875)
#define FLOOR_SQRT_MAX_DATA_TYPE_VAL (1)
