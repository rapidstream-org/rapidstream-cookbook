...
#define INVOKE_HIERMERGE_UNITS_FOR_PE(PE) \
    ...
    .invoke(merge_dual_streams, PE, 0, 3, PE_##PE##_dist_stage2[0], PE_##PE##_id_stage2[0], PE_##PE##_dist_stage2[1], PE_##PE##_id_stage2[1], L0_out_dist[PE],L0_out_id[PE])
...
void compute_KNN(   int debug_pe_idx,
                    ...
                    tapa::ostreams<LOCAL_DIST_DTYPE, 8>&     compute_to_sort_stream)
{
#pragma HLS INLINE OFF
...
void Knn(
    ...
    tapa::task()
        ...
        .invoke( merge_dual_streams_FINAL, -1, 0, 1, L2_out_dist[0], L2_out_id[0], L2_out_dist[1], L2_out_id[1], final_out_dist, final_out_id);
}
