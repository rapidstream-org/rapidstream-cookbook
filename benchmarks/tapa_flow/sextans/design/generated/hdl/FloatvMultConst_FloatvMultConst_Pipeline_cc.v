...
always @ (posedge ap_clk) begin
    if (((icmp_ln90_fu_201_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln90_fu_201_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (p_vld_fu_207_p1 == 1'd1))) begin
...
always @ (*) begin
    if (((icmp_ln90_fu_201_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((fifo_in_s_empty_n == 1'b1) & (icmp_ln90_fu_201_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        fifo_in_s_read = 1'b1;
    end else begin
        fifo_in_s_read = 1'b0;
    end
...
always @ (*) begin
    ap_condition_622 = ((icmp_ln90_fu_201_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (p_vld_fu_207_p1 == 1'd1));
end
...
assign icmp_ln90_fu_201_p2 = (($signed(ap_sig_allocacmp_i_1) < $signed(num_ite)) ? 1'b1 : 1'b0);
