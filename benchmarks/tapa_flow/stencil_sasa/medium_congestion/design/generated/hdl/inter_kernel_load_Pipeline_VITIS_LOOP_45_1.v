...
module inter_kernel_load_Pipeline_VITIS_LOOP_45_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] icmp_ln47_reg_422;
wire   [31:0] select_ln47_fu_256_p3;
reg   [31:0] select_ln47_reg_426;
wire   [0:0] tmp_3_nbreadreq_fu_97_p3;
wire   [0:0] icmp_ln56_fu_264_p2;
...
wire   [0:0] icmp_ln45_1_fu_221_p2;
wire  signed [31:0] icmp_ln47_fu_232_p0;
wire  signed [31:0] sext_ln47_fu_237_p0;
wire  signed [63:0] sext_ln47_fu_237_p1;
wire  signed [31:0] add_ln48_fu_250_p0;
wire   [0:0] select_ln47_fu_256_p0;
wire   [31:0] add_ln48_fu_250_p2;
wire  signed [31:0] select_ln47_fu_256_p2;
wire  signed [31:0] icmp_ln56_fu_264_p0;
wire   [511:0] trunc_ln104_fu_281_p1;
wire  signed [63:0] sext_ln57_fu_304_p1;
wire   [511:0] trunc_ln85_fu_316_p1;
wire   [8:0] zext_ln62_fu_339_p1;
wire   [8:0] add_ln62_fu_342_p2;
wire   [31:0] zext_ln62_1_fu_348_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            k_rd_req_fu_76 <= select_ln47_reg_426;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        icmp_ln45_reg_414 <= icmp_ln45_fu_216_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (or_ln45_fu_226_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        icmp_ln47_reg_422 <= icmp_ln47_fu_232_p2;
        icmp_ln56_reg_439 <= icmp_ln56_fu_264_p2;
        tmp_1_reg_455 <= tmp_1_nbreadreq_fu_137_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (or_ln45_fu_226_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln47_fu_232_p2 == 1'd1))) begin
        select_ln47_reg_426 <= select_ln47_fu_256_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (or_ln45_fu_226_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln45_fu_216_p2 == 1'd1))) begin
        tmp_3_reg_431 <= tmp_3_nbreadreq_fu_97_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (or_ln45_fu_226_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (tmp_3_nbreadreq_fu_97_p3 == 1'd1) & (icmp_ln45_fu_216_p2 == 1'd1))) begin
        tmp_4_reg_435 <= stream_out_full_n;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (or_ln45_fu_226_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (tmp_s_nbwritereq_fu_113_p3 == 1'd1) & (icmp_ln56_fu_264_p2 == 1'd1))) begin
        tmp_5_reg_447 <= a_write_data_full_n;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (or_ln45_fu_226_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (tmp_5_nbwritereq_fu_121_p3 == 1'd1) & (tmp_s_nbwritereq_fu_113_p3 == 1'd1) & (icmp_ln56_fu_264_p2 == 1'd1))) begin
        tmp_6_reg_451 <= tmp_6_nbreadreq_fu_129_p3;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (or_ln45_fu_226_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln56_fu_264_p2 == 1'd1))) begin
        tmp_s_reg_443 <= a_write_addr_full_n;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (tmp_1_nbreadreq_fu_137_p3 == 1'd1) & (or_ln45_fu_226_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        trunc_ln85_1_reg_459 <= trunc_ln85_1_fu_269_p1;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_6_reg_451 == 1'd1) & (tmp_5_reg_447 == 1'd1) & (tmp_s_reg_443 == 1'd1) & (icmp_ln56_reg_439 == 1'd1) & (or_ln45_reg_418 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_subdone) & (or_ln45_fu_226_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((b_read_addr_full_n == 1'b1) & (1'b0 == ap_block_pp0_stage1_11001) & (or_ln45_fu_226_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln47_fu_232_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((b_read_data_s_empty_n == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_4_reg_435 == 1'd1) & (tmp_3_reg_431 == 1'd1) & (icmp_ln45_reg_414 == 1'd1) & (or_ln45_reg_418 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_4_reg_435 == 1'd1) & (tmp_3_reg_431 == 1'd1) & (icmp_ln45_reg_414 == 1'd1) & (or_ln45_reg_418 == 1'd1))) begin
...
assign a_write_addr_din = {{1'd0}, {sext_ln57_fu_304_p1}};

assign a_write_data_din = {{1'd0}, {trunc_ln85_fu_316_p1}};

assign add_ln48_fu_250_p0 = k_rd_req_fu_76;

assign add_ln48_fu_250_p2 = ($signed(add_ln48_fu_250_p0) + $signed(32'd1));

assign add_ln62_fu_342_p2 = (zext_ln62_fu_339_p1 + 9'd1);
...
always @ (*) begin
    ap_condition_400 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln47_reg_422 == 1'd1) & (or_ln45_reg_418 == 1'd1));
end

always @ (*) begin
    ap_condition_406 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_4_reg_435 == 1'd1) & (tmp_3_reg_431 == 1'd1) & (icmp_ln45_reg_414 == 1'd1) & (or_ln45_reg_418 == 1'd1));
end

always @ (*) begin
    ap_condition_413 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_6_reg_451 == 1'd1) & (tmp_5_reg_447 == 1'd1) & (tmp_s_reg_443 == 1'd1) & (icmp_ln56_reg_439 == 1'd1) & (or_ln45_reg_418 == 1'd1));
end

always @ (*) begin
    ap_condition_417 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_1_reg_455 == 1'd1) & (or_ln45_reg_418 == 1'd1));
end
...
always @ (*) begin
    ap_predicate_op53_read_state2 = ((tmp_1_nbreadreq_fu_137_p3 == 1'd1) & (or_ln45_fu_226_p2 == 1'd1));
end

always @ (*) begin
    ap_predicate_op62_write_state3 = ((tmp_4_reg_435 == 1'd1) & (tmp_3_reg_431 == 1'd1) & (icmp_ln45_reg_414 == 1'd1) & (or_ln45_reg_418 == 1'd1));
end

always @ (*) begin
    ap_predicate_op68_write_state3 = ((tmp_6_reg_451 == 1'd1) & (tmp_5_reg_447 == 1'd1) & (tmp_s_reg_443 == 1'd1) & (icmp_ln56_reg_439 == 1'd1) & (or_ln45_reg_418 == 1'd1));
end

always @ (*) begin
    ap_predicate_op69_read_state3 = ((tmp_6_reg_451 == 1'd1) & (tmp_5_reg_447 == 1'd1) & (tmp_s_reg_443 == 1'd1) & (icmp_ln56_reg_439 == 1'd1) & (or_ln45_reg_418 == 1'd1));
end

always @ (*) begin
    ap_predicate_op72_write_state3 = ((tmp_6_reg_451 == 1'd1) & (tmp_5_reg_447 == 1'd1) & (tmp_s_reg_443 == 1'd1) & (icmp_ln56_reg_439 == 1'd1) & (or_ln45_reg_418 == 1'd1));
end

assign b_read_addr_din = {{1'd0}, {sext_ln47_fu_237_p1}};

assign icmp_ln45_1_fu_221_p2 = ((k_wr_resp_fu_80 < loop_bound) ? 1'b1 : 1'b0);

assign icmp_ln45_fu_216_p2 = ((k_rd_resp_fu_72 < loop_bound) ? 1'b1 : 1'b0);

assign icmp_ln47_fu_232_p0 = k_rd_req_fu_76;

assign icmp_ln47_fu_232_p2 = ((icmp_ln47_fu_232_p0 < loop_bound) ? 1'b1 : 1'b0);

assign icmp_ln56_fu_264_p0 = k_wr_req_fu_68;

assign icmp_ln56_fu_264_p2 = ((icmp_ln56_fu_264_p0 < loop_bound) ? 1'b1 : 1'b0);

assign k_rd_resp_2_fu_294_p2 = (k_rd_resp_1_reg_404 + 32'd1);

assign k_wr_req_2_fu_329_p2 = ($signed(k_wr_req_1_reg_398) + $signed(32'd1));

assign k_wr_resp_2_fu_352_p2 = (zext_ln62_1_fu_348_p1 + k_wr_resp_1_reg_409);

assign or_ln45_fu_226_p2 = (icmp_ln45_fu_216_p2 | icmp_ln45_1_fu_221_p2);

assign select_ln47_fu_256_p0 = b_read_addr_full_n;

assign select_ln47_fu_256_p2 = k_rd_req_fu_76;

assign select_ln47_fu_256_p3 = ((select_ln47_fu_256_p0[0:0] == 1'b1) ? add_ln48_fu_250_p2 : select_ln47_fu_256_p2);

assign sext_ln47_fu_237_p0 = k_rd_req_fu_76;

assign sext_ln47_fu_237_p1 = sext_ln47_fu_237_p0;

assign sext_ln57_fu_304_p1 = k_wr_req_1_reg_398;
...
assign zext_ln62_1_fu_348_p1 = add_ln62_fu_342_p2;

assign zext_ln62_fu_339_p1 = trunc_ln85_1_reg_459;

endmodule //inter_kernel_load_Pipeline_VITIS_LOOP_45_1
