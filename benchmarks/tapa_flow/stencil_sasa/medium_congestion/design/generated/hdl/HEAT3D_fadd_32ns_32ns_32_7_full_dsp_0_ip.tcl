...
create_ip -name floating_point -version $fpo_ver -vendor xilinx.com -library ip -module_name HEAT3D_fadd_32ns_32ns_32_7_full_dsp_0_ip
# BEGIN Vivado Commands
...
set_property -dict [list CONFIG.a_precision_type Single \
                          ...
                          CONFIG.component_name HEAT3D_fadd_32ns_32ns_32_7_full_dsp_0_ip \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips HEAT3D_fadd_32ns_32ns_32_7_full_dsp_0_ip] -quiet
# END Vivado Parameters
set_property generate_synth_checkpoint false [get_files HEAT3D_fadd_32ns_32ns_32_7_full_dsp_0_ip.xci]
generate_target {synthesis simulation} [get_files HEAT3D_fadd_32ns_32ns_32_7_full_dsp_0_ip.xci]
