...
wire   [0:0] trunc_ln133_fu_250_p1;
reg   [0:0] trunc_ln133_reg_282;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if ((((trunc_ln133_fu_250_p1 == 1'd1) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln133_fu_254_p2 == 1'd0)) | ((trunc_ln133_fu_250_p1 == 1'd0) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln133_fu_254_p2 == 1'd0)))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        trunc_ln133_reg_282 <= trunc_ln133_fu_250_p1;
    end
end

always @ (*) begin
    if (((trunc_ln133_reg_282 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (*) begin
    if (((trunc_ln133_reg_282 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        a_write_addr_write = grp_load_fu_218_a_write_addr_write;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln133_fu_254_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        if ((trunc_ln133_reg_282 == 1'd1)) begin
            grp_load_fu_218_a_write_addr_full_n = a_write_addr_full_n;
        end else if ((trunc_ln133_reg_282 == 1'd0)) begin
...
always @ (*) begin
    if ((((trunc_ln133_reg_282 == 1'd1) & (1'b1 == ap_CS_fsm_state3)) | ((trunc_ln133_reg_282 == 1'd0) & (1'b1 == ap_CS_fsm_state3)))) begin
        stream_in_s_read = grp_load_fu_218_stream_in_s_read;
    end else begin
...
always @ (*) begin
    ap_block_state3_on_subcall_done = (((trunc_ln133_reg_282 == 1'd1) & (grp_load_fu_218_ap_done == 1'b0)) | ((trunc_ln133_reg_282 == 1'd0) & (grp_load_fu_218_ap_done == 1'b0)));
end
...
assign icmp_ln133_fu_254_p2 = ((i_fu_72 == iters) ? 1'b1 : 1'b0);

assign stream_in_peek_read = 1'b0;

assign stream_out_din = grp_load_fu_218_stream_out_din;

assign trunc_ln133_fu_250_p1 = i_fu_72[0:0];
