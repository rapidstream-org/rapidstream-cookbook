...
#(parameter
    ...
    output wire [63:0]                   out_12,
    output wire [63:0]                   in_13,
    output wire [63:0]                   out_13,
    output wire [63:0]                   in_14,
    output wire [63:0]                   out_14,
...
// 0x12c : reserved
// 0x130 : Data signal of in_12
//         bit 31~0 - in_12[31:0] (Read/Write)
// 0x134 : Data signal of in_12
//         bit 31~0 - in_12[63:32] (Read/Write)
// 0x138 : reserved
// 0x13c : Data signal of out_12
//         bit 31~0 - out_12[31:0] (Read/Write)
// 0x140 : Data signal of out_12
//         bit 31~0 - out_12[63:32] (Read/Write)
// 0x144 : reserved
// 0x148 : Data signal of in_13
//         bit 31~0 - in_13[31:0] (Read/Write)
// 0x14c : Data signal of in_13
//         bit 31~0 - in_13[63:32] (Read/Write)
// 0x150 : reserved
// 0x154 : Data signal of out_13
//         bit 31~0 - out_13[31:0] (Read/Write)
// 0x158 : Data signal of out_13
//         bit 31~0 - out_13[63:32] (Read/Write)
// 0x15c : reserved
// 0x160 : Data signal of in_14
//         bit 31~0 - in_14[31:0] (Read/Write)
// 0x164 : Data signal of in_14
//         bit 31~0 - in_14[63:32] (Read/Write)
// 0x168 : reserved
// 0x16c : Data signal of out_14
//         bit 31~0 - out_14[31:0] (Read/Write)
// 0x170 : Data signal of out_14
//         bit 31~0 - out_14[63:32] (Read/Write)
// 0x174 : reserved
// 0x178 : Data signal of iters
...
localparam
    ...
    ADDR_IN_12_DATA_0  = 9'h130,
    ADDR_IN_12_DATA_1  = 9'h134,
    ADDR_IN_12_CTRL    = 9'h138,
    ADDR_OUT_12_DATA_0 = 9'h13c,
    ADDR_OUT_12_DATA_1 = 9'h140,
    ADDR_OUT_12_CTRL   = 9'h144,
    ADDR_IN_13_DATA_0  = 9'h148,
    ADDR_IN_13_DATA_1  = 9'h14c,
    ADDR_IN_13_CTRL    = 9'h150,
    ADDR_OUT_13_DATA_0 = 9'h154,
    ADDR_OUT_13_DATA_1 = 9'h158,
    ADDR_OUT_13_CTRL   = 9'h15c,
    ADDR_IN_14_DATA_0  = 9'h160,
    ADDR_IN_14_DATA_1  = 9'h164,
    ADDR_IN_14_CTRL    = 9'h168,
    ADDR_OUT_14_DATA_0 = 9'h16c,
    ADDR_OUT_14_DATA_1 = 9'h170,
    ADDR_OUT_14_CTRL   = 9'h174,
    ADDR_ITERS_DATA_0  = 9'h178,
    ADDR_ITERS_CTRL    = 9'h17c,
    WRIDLE             = 2'd0,
    WRDATA             = 2'd1,
    WRRESP             = 2'd2,
    WRRESET            = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [63:0]                   int_out_12 = 'b0;
    reg  [63:0]                   int_in_13 = 'b0;
    reg  [63:0]                   int_out_13 = 'b0;
    reg  [63:0]                   int_in_14 = 'b0;
    reg  [63:0]                   int_out_14 = 'b0;
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_OUT_12_DATA_0: begin
                    rdata <= int_out_12[31:0];
                end
                ADDR_OUT_12_DATA_1: begin
                    rdata <= int_out_12[63:32];
                end
                ...
                ADDR_OUT_13_DATA_0: begin
                    rdata <= int_out_13[31:0];
                end
                ADDR_OUT_13_DATA_1: begin
                    rdata <= int_out_13[63:32];
                end
                ...
                ADDR_OUT_14_DATA_0: begin
                    rdata <= int_out_14[31:0];
                end
                ADDR_OUT_14_DATA_1: begin
                    rdata <= int_out_14[63:32];
                end
...
assign out_12            = int_out_12;
assign in_13             = int_in_13;
assign out_13            = int_out_13;
assign in_14             = int_in_14;
assign out_14            = int_out_14;
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_OUT_12_DATA_0)
            int_out_12[31:0] <= (WDATA[31:0] & wmask) | (int_out_12[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_OUT_12_DATA_1)
            int_out_12[63:32] <= (WDATA[31:0] & wmask) | (int_out_12[63:32] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_OUT_13_DATA_0)
            int_out_13[31:0] <= (WDATA[31:0] & wmask) | (int_out_13[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_OUT_13_DATA_1)
            int_out_13[63:32] <= (WDATA[31:0] & wmask) | (int_out_13[63:32] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_OUT_14_DATA_0)
            int_out_14[31:0] <= (WDATA[31:0] & wmask) | (int_out_14[31:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_OUT_14_DATA_1)
            int_out_14[63:32] <= (WDATA[31:0] & wmask) | (int_out_14[63:32] & ~wmask);
    end
end
