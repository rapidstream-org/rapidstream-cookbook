...
(* CORE_GENERATION_INFO="inter_kernel_inter_kernel,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcu280-fsvh2892-2L-e,HLS_INPUT_CLOCK=3.330000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.430900,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=584,HLS_SYN_LUT=887,HLS_VERSION=2022_2}" *)
...
wire   [0:0] trunc_ln143_fu_250_p1;
reg   [0:0] trunc_ln143_reg_282;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        trunc_ln143_reg_282 <= trunc_ln143_fu_250_p1;
    end
end

always @ (*) begin
    if (((trunc_ln143_reg_282 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    if (((trunc_ln143_reg_282 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        a_write_addr_write = grp_load_fu_218_a_write_addr_write;
    end else begin
...
always @ (*) begin
    if (((icmp_ln143_fu_254_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        if ((trunc_ln143_reg_282 == 1'd1)) begin
            grp_load_fu_218_a_write_addr_full_n = a_write_addr_full_n;
        end else if ((trunc_ln143_reg_282 == 1'd0)) begin
...
always @ (*) begin
    if ((((trunc_ln143_reg_282 == 1'd1) & (1'b1 == ap_CS_fsm_state4)) | ((trunc_ln143_reg_282 == 1'd0) & (1'b1 == ap_CS_fsm_state4)))) begin
        stream_in_s_read = grp_load_fu_218_stream_in_s_read;
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((icmp_ln143_fu_254_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if (((trunc_ln143_fu_250_p1 == 1'd1) & (icmp_ln143_fu_254_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_state4_on_subcall_done = (((trunc_ln143_reg_282 == 1'd1) & (grp_load_fu_218_ap_done == 1'b0)) | ((trunc_ln143_reg_282 == 1'd0) & (grp_load_fu_218_ap_done == 1'b0)));
end
...
assign icmp_ln143_fu_254_p2 = ((i_fu_72 == iters) ? 1'b1 : 1'b0);

assign stream_in_peek_read = 1'b0;

assign stream_out_din = grp_load_fu_218_stream_out_din;

assign trunc_ln143_fu_250_p1 = i_fu_72[0:0];
