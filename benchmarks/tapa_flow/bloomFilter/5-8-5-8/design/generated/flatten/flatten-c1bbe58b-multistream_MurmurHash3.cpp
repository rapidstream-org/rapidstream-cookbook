...
)
{
    ...
    tapa::stream<ap_uint<BV_PACKED_BITWIDTH>, (( ((5)-1)/2 + 1))> bv_load_stream_3;
    tapa::stream<ap_uint<BV_PACKED_BITWIDTH>, (( ((5)-1)/2 + 1))> bv_load_stream_4;
    ...
    tapa::streams<ap_uint<HASHONLY_BITWIDTH>, (5), (( ((5)-1)/2 + 1))> hash_stream_h3_kp0;
    tapa::streams<ap_uint<HASHONLY_BITWIDTH>, (5), (( ((5)-1)/2 + 1))> hash_stream_h3_kp1;
    tapa::streams<ap_uint<HASHONLY_BITWIDTH>, (5), (( ((5)-1)/2 + 1))> hash_stream_h4_kp0;
    tapa::streams<ap_uint<HASHONLY_BITWIDTH>, (5), (( ((5)-1)/2 + 1))> hash_stream_h4_kp1;
    // Arbiter outputs
    ...
    tapa::streams<PACKED_HASH_DTYPE, (8) /* each sub bv is further partitioned into this chunks*/, (( ((5)-1)/2 + 1))> bv_lookup_stream_h3_kp0;
    tapa::streams<PACKED_HASH_DTYPE, (8) /* each sub bv is further partitioned into this chunks*/, (( ((5)-1)/2 + 1))> bv_lookup_stream_h3_kp1;
    tapa::streams<PACKED_HASH_DTYPE, (8) /* each sub bv is further partitioned into this chunks*/, (( ((5)-1)/2 + 1))> bv_lookup_stream_h4_kp0;
    tapa::streams<PACKED_HASH_DTYPE, (8) /* each sub bv is further partitioned into this chunks*/, (( ((5)-1)/2 + 1))> bv_lookup_stream_h4_kp1;
    // Query unit outputs
    ...
    tapa::streams<BV_PLUS_METADATA_PACKED_DTYPE, (8) /* each sub bv is further partitioned into this chunks*/, (( ((5)-1)/2 + 1))> query_bv_packed_stream_hash3_kp0;
    tapa::streams<BV_PLUS_METADATA_PACKED_DTYPE, (8) /* each sub bv is further partitioned into this chunks*/, (( ((5)-1)/2 + 1))> query_bv_packed_stream_hash3_kp1;
    tapa::streams<BV_PLUS_METADATA_PACKED_DTYPE, (8) /* each sub bv is further partitioned into this chunks*/, (( ((5)-1)/2 + 1))> query_bv_packed_stream_hash4_kp0;
    tapa::streams<BV_PLUS_METADATA_PACKED_DTYPE, (8) /* each sub bv is further partitioned into this chunks*/, (( ((5)-1)/2 + 1))> query_bv_packed_stream_hash4_kp1;
    // Shuffle unit output
    tapa::streams<ap_uint<BIT_BITWIDTH>, (5), (( ((5)-1)/2 + 1))> reconstruct_stream_stm0_kp0;
    tapa::streams<ap_uint<BIT_BITWIDTH>, (5), (( ((5)-1)/2 + 1))> reconstruct_stream_stm0_kp1;
    tapa::streams<ap_uint<BIT_BITWIDTH>, (5), (( ((5)-1)/2 + 1))> reconstruct_stream_stm1_kp0;
    tapa::streams<ap_uint<BIT_BITWIDTH>, (5), (( ((5)-1)/2 + 1))> reconstruct_stream_stm1_kp1;
    tapa::streams<ap_uint<BIT_BITWIDTH>, (5), (( ((5)-1)/2 + 1))> reconstruct_stream_stm2_kp0;
    tapa::streams<ap_uint<BIT_BITWIDTH>, (5), (( ((5)-1)/2 + 1))> reconstruct_stream_stm2_kp1;
    tapa::streams<ap_uint<BIT_BITWIDTH>, (5), (( ((5)-1)/2 + 1))> reconstruct_stream_stm3_kp0;
    tapa::streams<ap_uint<BIT_BITWIDTH>, (5), (( ((5)-1)/2 + 1))> reconstruct_stream_stm3_kp1;
    tapa::streams<ap_uint<BIT_BITWIDTH>, (5), (( ((5)-1)/2 + 1))> reconstruct_stream_stm4_kp0;
    tapa::streams<ap_uint<BIT_BITWIDTH>, (5), (( ((5)-1)/2 + 1))> reconstruct_stream_stm4_kp1;
    // Aggregate output
