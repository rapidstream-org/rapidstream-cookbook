...
int main(int argc, char **argv) {
    ...
    //while (match && test_number < NUM_TESTS_TO_RUN)
    {
        ...
        for (int i = 0; i < KEYPAIRS_PER_STM; ++i)
        {
            ...
            cur_packed_input.s4_k0 = keys[i*2*NUM_STM + 2*4 + 0];
            cur_packed_input.s4_k1 = keys[i*2*NUM_STM + 2*4 + 1];
        ...
        for (int j = 0; j < PACKED_OUTPUTS_PER_STM; ++j) {
            ...
            dummy.s4_k0 = 123123;
            dummy.s4_k1 = 123123;
            dummy.padding_5_k0 = 123123;
            dummy.padding_5_k1 = 123123;
            dummy.padding_6_k0 = 123123;
            dummy.padding_6_k1 = 123123;
            dummy.padding_7_k0 = 123123;
            dummy.padding_7_k1 = 123123;
        ...
        if (do_verif){
            ...
            for (int i = 0; i < PACKED_OUTPUTS_PER_STM; ++i)
            {
                for (int j = 0; j < OUT_PACKED_BITWIDTH; ++j)
                {
                        ...
                        krnl_merged_out[out_bit_idx++].range(0, 0) =
                            krnl_out[i].s4_k0.range(j, j);
                        krnl_merged_out[out_bit_idx++].range(0, 0) =
                            krnl_out[i].s4_k1.range(j, j);
