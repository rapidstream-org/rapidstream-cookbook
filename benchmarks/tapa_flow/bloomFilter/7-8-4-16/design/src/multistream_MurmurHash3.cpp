...
void loadBV(
    ...
    ,tapa::ostream<BV_PACKED_DTYPE>    & bv_load_stream_0
    ,tapa::ostream<BV_PACKED_DTYPE>    & bv_load_stream_1
    ,tapa::ostream<BV_PACKED_DTYPE>    & bv_load_stream_2
    ,tapa::ostream<BV_PACKED_DTYPE>    & bv_load_stream_3
    ,tapa::ostream<BV_PACKED_DTYPE>    & bv_load_stream_4
    ,tapa::ostream<BV_PACKED_DTYPE>    & bv_load_stream_5
    ,tapa::ostream<BV_PACKED_DTYPE>    & bv_load_stream_6
    #if NUM_HASH != 7
    ,crash,
    #endif
            ...
            i_resp < BV_NUM_LOADS; )
    {
        ...
        if (!input_bv.read_data.empty()) {
            ...
            #ifdef __DO_DEBUG_PRINTS__
            for (int i = 0; i < BV_PACKED_BITWIDTH; ++i)
            {
                int total_idx = i_resp*BV_PACKED_BITWIDTH + i;
                BIT_DTYPE cur_bit;
...
#define INVOKE_COMPUTERS_FOR_STM(STM_IDX, KP_IDX)\
    ...
    INVOKE_COMPUTERS_FOR_HASH(5, STM_IDX, KP_IDX)\
    INVOKE_COMPUTERS_FOR_HASH(6, STM_IDX, KP_IDX)\
...
#define ARBITER_STREAM_DECLS_KP(KP_IDX)    \
    ...
    tapa::streams<PACKED_HASH_DTYPE, NUM_STM*BV_NUM_PARTITIONS> arb5_streams_kp##KP_IDX;   \
    tapa::streams<PACKED_HASH_DTYPE, NUM_STM*BV_NUM_PARTITIONS> arb6_streams_kp##KP_IDX;   \
...
#define ARBITER_INVOKES_FOR_KP(KP_IDX)  \
        ...
        .invoke( bloom_arb_forwarder,   \
                    5,  \
                    KP_IDX, \
                    hash_stream_h5_kp##KP_IDX,  \
                    arb5_streams_kp##KP_IDX    \
        )   \
        .invoke( bloom_arb_forwarder,   \
                    6,  \
                    KP_IDX, \
                    hash_stream_h6_kp##KP_IDX,  \
                    arb6_streams_kp##KP_IDX    \
        )   \
\
        ...
        .invoke( bloom_single_arbiter,  \
                    ...
                    KP_IDX, \
                    arb5_streams_kp##KP_IDX,   \
                    bv_lookup_stream_h5_kp##KP_IDX  \
        )   \
        .invoke( bloom_single_arbiter,  \
                    6,  \
                    KP_IDX, \
                    arb6_streams_kp##KP_IDX,   \
                    bv_lookup_stream_h6_kp##KP_IDX  \
        )   \
...
void queryResult_per_hash(
        int hash_idx
        ,tapa::istream<BV_PACKED_DTYPE>                                 & bv_load_stream
    ...
    BV_PACKED_DTYPE     bv_buf_BRAMS[BV_NUM_BRAM_PARTITIONS][BV_PARTITION_LENGTH_IN_PACKED_ELEMS];
    ...
    BV_PACKED_DTYPE     bv_buf_URAMS[BV_NUM_URAM_PARTITIONS][BV_PARTITION_LENGTH_IN_PACKED_ELEMS];
    ...
    printf("queryBV is not properly datapacking the URAMs.\n");
    #endif

    BV_PACKED_DTYPE cur_bv_val;
    ...
    LOAD_BV_VALUES:
    for (int i = 0; i < BV_SECTION_LENGTH_IN_PACKED_ELEMS; ++i) {
        #pragma HLS PIPELINE II=1
        cur_bv_val = bv_load_stream.read();

        int partition_idx = i/BV_PARTITION_LENGTH_IN_PACKED_ELEMS;
        int element_idx = i%BV_PARTITION_LENGTH_IN_PACKED_ELEMS;

        if (partition_idx < BV_NUM_BRAM_PARTITIONS) {
            bv_buf_BRAMS[partition_idx][element_idx] = cur_bv_val;

            #ifdef __DO_DEBUG_PRINTS__
            printf("QUERY UNIT %d - %d, %d\n",
                    hash_idx, partition_idx, element_idx);
            for (int j = 0; j < BV_PACKED_BITWIDTH; ++j) {
                BIT_DTYPE tmp;
                tmp.range(0,0) = bv_buf_BRAMS[partition_idx][element_idx].range(j,j);
                printf("QUERY UNIT %d - bv[%d] = %d\n",
                        hash_idx,
                        i*BV_PACKED_BITWIDTH+j,
                        tmp.to_int()
                );
            }
            #endif
            ...
            bv_buf_URAMS[partition_idx-BV_NUM_BRAM_PARTITIONS][element_idx] = cur_bv_val;
            ...
            for (int j = 0; j < BV_PACKED_BITWIDTH; ++j) {
                BIT_DTYPE tmp;
                tmp.range(0,0) = bv_buf_URAMS[partition_idx][element_idx].range(j,j);
                printf("QUERY UNIT %d - bv[%d] = %d\n",
                        hash_idx,
                        i*BV_PACKED_BITWIDTH+j,
                        tmp.to_int()
...
#define QUERY_INVOKES   \
        ...
        .invoke(\
                ...
                , bv_lookup_stream_h5_kp1\
                , query_bv_packed_stream_hash5_kp0\
                , query_bv_packed_stream_hash5_kp1\
        )\
        .invoke(\
                queryResult_per_hash\
                , 6\
                , bv_load_stream_6\
                , bv_lookup_stream_h6_kp0\
                , bv_lookup_stream_h6_kp1\
                , query_bv_packed_stream_hash6_kp0\
                , query_bv_packed_stream_hash6_kp1\
        )\
...
#define SHUFFLE_STREAM_DECLS_KP(KP_IDX)    \
    ...
    tapa::streams<BV_PLUS_IIDX_PACKED_DTYPE, NUM_STM*BV_NUM_PARTITIONS> inter_shuf5_stm_kp##KP_IDX;   \
    tapa::streams<BV_PLUS_IIDX_PACKED_DTYPE, NUM_STM*BV_NUM_PARTITIONS> inter_shuf6_stm_kp##KP_IDX;   \
...
#define SHUFFLE_INVOKES_FOR_KP(KP_IDX)     \
        ...
        .invoke<tapa::detach>(    \
            ...
            , 5 \
            , KP_IDX    \
            , query_bv_packed_stream_hash5_kp##KP_IDX  \
            , inter_shuf5_stm_kp##KP_IDX \
            \
        )   \
        .invoke<tapa::detach>(    \
            shuffle_TtoS_per_hash    \
            , 6 \
            , KP_IDX    \
            , query_bv_packed_stream_hash6_kp##KP_IDX  \
            , inter_shuf6_stm_kp##KP_IDX \
            \
        )   \
        ...
        SHUFFLE_REORDER_INVOKES_FOR_SHUF_KP(5, KP_IDX)  \
        SHUFFLE_REORDER_INVOKES_FOR_SHUF_KP(6, KP_IDX)  \
...

{
    ...
    // loadBV outputs
    tapa::stream<BV_PACKED_DTYPE, STM_DEPTH> bv_load_stream_0;
    tapa::stream<BV_PACKED_DTYPE, STM_DEPTH> bv_load_stream_1;
    tapa::stream<BV_PACKED_DTYPE, STM_DEPTH> bv_load_stream_2;
    tapa::stream<BV_PACKED_DTYPE, STM_DEPTH> bv_load_stream_3;
    tapa::stream<BV_PACKED_DTYPE, STM_DEPTH> bv_load_stream_4;
    tapa::stream<BV_PACKED_DTYPE, STM_DEPTH> bv_load_stream_5;
    tapa::stream<BV_PACKED_DTYPE, STM_DEPTH> bv_load_stream_6;
    #if NUM_HASH != 7
    crash!
    #endif
    ...
    tapa::streams<HASHONLY_DTYPE, NUM_STM, STM_DEPTH> hash_stream_h5_kp0;
    tapa::streams<HASHONLY_DTYPE, NUM_STM, STM_DEPTH> hash_stream_h5_kp1;
    tapa::streams<HASHONLY_DTYPE, NUM_STM, STM_DEPTH> hash_stream_h6_kp0;
    tapa::streams<HASHONLY_DTYPE, NUM_STM, STM_DEPTH> hash_stream_h6_kp1;
    #if NUM_HASH != 7
    crash!
    #endif
    ...
    tapa::streams<PACKED_HASH_DTYPE, BV_NUM_PARTITIONS, STM_DEPTH> bv_lookup_stream_h5_kp0;
    tapa::streams<PACKED_HASH_DTYPE, BV_NUM_PARTITIONS, STM_DEPTH> bv_lookup_stream_h5_kp1;
    tapa::streams<PACKED_HASH_DTYPE, BV_NUM_PARTITIONS, STM_DEPTH> bv_lookup_stream_h6_kp0;
    tapa::streams<PACKED_HASH_DTYPE, BV_NUM_PARTITIONS, STM_DEPTH> bv_lookup_stream_h6_kp1;
    #if NUM_HASH != 7
    crash!
    #endif
    ...
    tapa::streams<BV_PLUS_METADATA_PACKED_DTYPE, BV_NUM_PARTITIONS, STM_DEPTH> query_bv_packed_stream_hash5_kp0;
    tapa::streams<BV_PLUS_METADATA_PACKED_DTYPE, BV_NUM_PARTITIONS, STM_DEPTH> query_bv_packed_stream_hash5_kp1;
    tapa::streams<BV_PLUS_METADATA_PACKED_DTYPE, BV_NUM_PARTITIONS, STM_DEPTH> query_bv_packed_stream_hash6_kp0;
    tapa::streams<BV_PLUS_METADATA_PACKED_DTYPE, BV_NUM_PARTITIONS, STM_DEPTH> query_bv_packed_stream_hash6_kp1;
    #if NUM_HASH != 7
    crash!!!
    #endif
