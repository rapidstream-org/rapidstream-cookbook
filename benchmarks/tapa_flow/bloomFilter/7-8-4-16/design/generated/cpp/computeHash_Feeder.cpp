...
#pragma HLS interface ap_fifo port = key_out_stream[5]._
#pragma HLS aggregate variable = key_out_stream[5]._ bit
void(key_out_stream[5]._.full());
#pragma HLS interface ap_fifo port = key_out_stream[6]._
#pragma HLS aggregate variable = key_out_stream[6]._ bit
void(key_out_stream[6]._.full());
