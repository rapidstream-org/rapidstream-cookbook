...
#pragma HLS interface ap_fifo port = reconstruct_stream[5]._
#pragma HLS aggregate variable = reconstruct_stream[5]._ bit
#pragma HLS interface ap_fifo port = reconstruct_stream[5]._peek
#pragma HLS aggregate variable = reconstruct_stream[5]._peek bit
void(reconstruct_stream[5]._.empty());
void(reconstruct_stream[5]._peek.empty());
#pragma HLS interface ap_fifo port = reconstruct_stream[6]._
#pragma HLS aggregate variable = reconstruct_stream[6]._ bit
#pragma HLS interface ap_fifo port = reconstruct_stream[6]._peek
#pragma HLS aggregate variable = reconstruct_stream[6]._peek bit
void(reconstruct_stream[6]._.empty());
void(reconstruct_stream[6]._peek.empty());
