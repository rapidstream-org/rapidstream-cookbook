...
always @ (*) begin
    if (((icmp_ln109_fu_128_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'd1 == and_ln43_fu_138_p2) & (edge_list_ptr_read_addr_full_n == 1'b1) & (icmp_ln109_fu_128_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'd1 == and_ln47_fu_168_p2) & (edge_list_ptr_read_data_s_empty_n == 1'b1) & (icmp_ln109_fu_128_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'd1 == and_ln47_fu_168_p2) & (fifo_edge_list_ptr_full_n == 1'b1) & (icmp_ln109_fu_128_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        fifo_edge_list_ptr_write = 1'b1;
    end else begin
...
assign and_ln43_fu_138_p1 = edge_list_ptr_read_addr_full_n;

assign and_ln43_fu_138_p2 = (icmp_ln43_fu_133_p2 & and_ln43_fu_138_p1);

assign and_ln47_fu_168_p0 = fifo_edge_list_ptr_full_n;
...
always @ (*) begin
    ap_condition_190 = ((1'd1 == and_ln43_fu_138_p2) & (icmp_ln109_fu_128_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_condition_193 = ((1'd1 == and_ln47_fu_168_p2) & (icmp_ln109_fu_128_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
assign edge_list_ptr_read_addr_din = {{1'd0}, {sext_ln44_fu_144_p1}};

assign fifo_edge_list_ptr_din = {{1'd0}, {trunc_ln78_fu_178_p1}};
...
assign icmp_ln109_fu_128_p2 = (($signed(i_resp_fu_54) < $signed(num_ite_plus1)) ? 1'b1 : 1'b0);

assign icmp_ln43_fu_133_p0 = i_req_fu_58;

assign icmp_ln43_fu_133_p2 = (($signed(icmp_ln43_fu_133_p0) < $signed(num_ite_plus1)) ? 1'b1 : 1'b0);
